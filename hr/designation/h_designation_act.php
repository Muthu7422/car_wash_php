...
$pm="insert into h_designation set dname='".strtoupper($_POST['stype'])."',description='".strtoupper($_POST['sdescription'])."',franchisee_id='".$var['branch_id']."',vendor_id='".$var1['vendor_id']."',status='Active'";  
