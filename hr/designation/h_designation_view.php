...
$pagename="h_designation_view.php";
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content container-fluid">
      <?php 
					  ...
					  {
					  ?>
       <h4><div align="right"><a href="h_designation.php"><b> CREATE NEW DESIGNATION</b></a></div></h4>  
					  <?php } ?>
	    <!-- left column -->
      ...
      <div class="row">
		...
		<?php
                ...
                <tr>
				  ...
				  <td><a href="h_designation_details_view.php?id=<?php  echo $FEss['id']; ?>" class="btn-box-tool"><i class="fa fa-eye custom-icon1"></i></a></td>
                  <td>
				  		<?php 
