...
$pm="insert into h_department set dname='".strtoupper($_POST['dtype'])."',description='".strtoupper($_POST['sdescription'])."',franchisee_id='".$var['branch_id']."',vendor_id='".$var1['vendor_id']."',status='Active'";  
