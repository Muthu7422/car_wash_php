 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
   ...
   ?>
    ...
    <form role="form" method="post" action="h_department_view.php?id=<?php echo $Fd['id']; ?>">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="dtype" id="dtype" value="<?php echo $Fd['dname']; ?>" placeholder="Department Type" required readonly>
