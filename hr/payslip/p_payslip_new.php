...
function gettotal($i)
{
	...
	{
		MonthlyIncentive=parseFloat(document.getElementById('MonthlyIncentive'+$i+'').value);
	}
	...
	{
		deduction=parseFloat(document.getElementById('deduction'+$i+'').value);
	} 
        ...
        <div class="col-md-12">
            ...
            <div class="box-body" style="overflow:auto">
             <table id="example1" class="table table-bordered table-striped" style="width:100%">
				...
				$atq=mysqli_query($conn,$at);
				while($atf=mysqli_fetch_array($atq))
				{
				...
				while($Fct=mysqli_fetch_array($Ect))
				{
					...
					$dcm=mysqli_query($conn,$spm);
					$dpm=mysqli_num_rows($dcm);
