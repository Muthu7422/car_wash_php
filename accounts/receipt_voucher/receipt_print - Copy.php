...
<tr>
<td align="left" width="350"><b>RECEIPT TO</b><br/><?PHP echo $epm1['cust_name']; ?><br/><?PHP echo $epm1['mobile1']; ?><br/>VAT.NO:<?PHP echo $epm1['vat']; ?></td>
...
<?php
$i=0;						
			$sdm1="select * from receipt_voucher where Voucher_Id='$Voucher_Id'";
			$scm1=mysqli_query($conn,$sdm1);
			while($dcm1=mysqli_fetch_array($scm1))
			{
$i++;
...
<td style="text-align:right"><?php echo number_format($dcm1['paid_amt'],2);?></td>
</tr>
<?php 
}
