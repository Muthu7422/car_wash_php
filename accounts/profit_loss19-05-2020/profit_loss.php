      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="profit_loss_report.php" autocomplete="off">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <a href="profit_loss.php"><button type="button" class="btn btn-default ">Cancel</button></a>
