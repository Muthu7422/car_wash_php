        ...
        <div class="col-md-8 col-md-offset-2">            
            ...
            <div class="box-body">
              <table id="" class="table table-bordered table-striped">
			   <thead>                
                  Cash Transaction From <?php echo $_POST['from']; ?>  To  <?php echo $_POST['to']; ?>              
                </thead>
				...
				$acc="select SUM(Amount) AS Amount from account_cash where TransactionType='Debit' AND TransactionDate<'$fdate'";
				$sccq=mysqli_query($conn,$acc);
				$acf=mysqli_fetch_array($sccq);
					
				$acc1="select SUM(Amount) AS Amount from account_cash where TransactionType='Credit'AND TransactionDate<'$fdate'";
				...
				$td=0;
				$i=0;
				$ct="select * from account_cash where TransactionDate between '$fdate' AND '$tdate' order by TransactionDate";
