...
<th align="LEFT" colspan="3" >TO,<BR />NAME :<span style="margin-left:26px"> M/S <B>&nbsp;&nbsp;<?PHP echo $Fs['sname']; ?></B></span><BR/>ADDRESS : <?PHP echo $Fs['saddress']; ?><BR/>MOBILE : <span style="margin-left:10px"><?PHP echo $Fs['smobile']; ?></span><BR/>STATE CODE : 33 <BR/></th>
