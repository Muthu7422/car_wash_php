...
function Delete_Click() {
  ...
  return false; 
    ...
    <form role="form" method="post" action="../cash_account/a_cash_acc_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
				...
				{
					$acc="select SUM(Amount) AS Amount from account_cash where TransactionType='Debit'";
					$sccq=mysqli_query($conn,$acc);
					$acf=mysqli_fetch_array($sccq);
					
					$acc1="select SUM(Amount) AS Amount from account_cash where TransactionType='Credit'";
