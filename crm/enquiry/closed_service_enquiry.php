          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
				...
				{
				$ss="select * from  crm_enquiry where Status='Active' and EnquiryStatus='6' order by id desc";
				}
				else
				{
					$ss="select * from  crm_enquiry where Status='Active' and FranchiseeId='".$_SESSION['FranchiseeId']."' and EnquiryStatus='6' order by id desc";
				}
