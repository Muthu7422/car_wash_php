...
function Delete_Click() {
 ...
 function fnGetDistrict() {
    ...
    <form role="form" method="post" action="detailsimport_act.php" autocomplete="off" enctype="multipart/form-data">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
             ...
             <div class="box-body">
				 ...
				 <div class="form-group col-sm-4">
                  <label for="Branch">File Name</label>
                  <input type="file" class="form-control" name="filen" id="filen" placeholder="File Name" onKeyPress="return tabE(this,event)">
