          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
				...
				{
				$ss="select * from  crm_enquiry where Status='Active' and EnquiryStatus='4' order by id desc";
				}
				else
				{
					$ss="select * from  crm_enquiry where Status='Active' and FranchiseeId='".$_SESSION['FranchiseeId']."' and EnquiryStatus='4' order by id desc";
				}
                ...
                <tr>
				 ...
				 <td><?php  echo $FEss['EnquiryStatus']; ?></td>
