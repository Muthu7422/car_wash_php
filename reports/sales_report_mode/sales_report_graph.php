...
if(isset($_POST['from']))
{
$sr="SELECT sum(total_amt) as y ,jdate as label FROM s_job_card where jdate between '".$_POST['from']."' AND '".$_POST['to']."' group by jdate";
...
<div class="wrapper">
 ...
 <form role="form" method="post" action="sales_report_graph.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
