			...
			<thead>
              <tr>
				...
				while($FEsco=mysqli_fetch_array($Esco))
				{
						...
						$ds1="select * from membership where id='".$FEsco['MemberShip']."'";
						$fc1=mysqli_query($conn,$ds1);
						$dxs1=mysqli_fetch_array($fc1);
				 $i++;
				?>
                <tr>MemberShip
                  <td><?php echo $i;  ?></td>
				  ...
				  <td><?php echo $dxs1['MemberShip']; ?></td>
				  <td><?php echo $FEsco['sdate']; ?></td>
				  <td><?php echo $FEsco['edate']; ?></td>
