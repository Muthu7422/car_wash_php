      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="service_type_process.php" autocomplete="off">
              <div class="box-body">
               ...
               <div class="form-group col-sm-4" style="padding-left:60px">
				...
				<?php
			    $ss="select * from m_service_type where franchisee_id='".$_SESSION['BranchId']."' order by id desc";
