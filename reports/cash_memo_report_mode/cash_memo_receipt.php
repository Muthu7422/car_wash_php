...
$date=date('d/m/Y');
 $s="select * from cash_memo where cash_memo_no='".$_REQUEST['cash_memo_no']."'"; 
$Es=mysql_query($s);
...
$dt=0;
$trs=0;
$gt1="select * from cash_memo_details where cash_memo_no='".$_REQUEST['cash_memo_no']."'";
$Egt1=mysql_query($gt1);
while($Fs1=mysql_fetch_array($Egt1))
{
$i++;

$it="select * from m_spare_brand where sid='".$Fs1['sbrand']."'";
$Eit=mysql_query($it);
$Fit=mysql_fetch_array($Eit);
$itt="select * from m_spare where sid='".$Fs1['sname']."'";
$Eitt=mysql_query($itt);
$Fitt=mysql_fetch_array($Eitt);
?>
<tr >
<td align="center" width="76" colspan="1"><?php echo $i; ?></td>
<td colspan="3"><?php echo $Fit['spare_brand']; ?></td>
<td colspan="4"><?php echo $Fitt['spare_name']; ?></td>
<td align="center" width="58" colspan="1"><?php echo $Fs1['qty']; ?></td>
<td align="center" colspan="3"><?php echo  $Fs1['mrp']; ?></td>
<td width="82" colspan="2"><?php echo $Fs1['total_amount']; ?></td>
</tr>
...
$rpm1="select * from cash_memo where cash_memo_no='".$_REQUEST['cash_memo_no']."'";
$eep1=mysql_query($rpm1);
$pos1=mysql_fetch_array($eep1);
?>
...
<td colspan="4" align="center"><b><?php echo $pos1['discount_amount']; ?></b></td>
</tr>
...
<td colspan="4" align="center"><b><?php echo round($pos1['bill_amount'], 0) ?>.00</b></td>
</tr>
...
<td align="left" colspan="5"> Tax Amount In Words <B>: <?php
   ...
   */
$number = round($pos1['bill_amount'], 0);
   $no = round($number);
