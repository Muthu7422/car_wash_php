 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content-header">
       <h1>
  Service Cash Memo Payment Mode
        <small>Report</small>
      </h1>      
	  ...
	  <br/>  <br/>  <br/>
	    ...
	    <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
			 	$ct="select * from service_cash_memo where date between '".$_REQUEST['from']."' and '".$_REQUEST['to']."' and bill_status='Open' and FranchiseeId='".$_SESSION['FranchiseeId']."' and payment_mode='".$_REQUEST['payment_mode']."'"; 
				$Ect=mysql_query($ct);
				$i=0;
               ...
               <tr>
				...
				<td><?php echo $Fct['bill_amount']; ?></td>
				 <td><a href="service_cash_memo_receipt.php?service_cash_memo_no=<?php echo $Fct['service_cash_memo_no']; ?>"  Onclick="return confirm('Are you sure want to proceed?')" title="Take Print" class="btn-box-tool"><i class="fa fa-print" style="font-size:20px;color:Black"></i></a></td>
                </tr>
				<?php
				}
				?>
