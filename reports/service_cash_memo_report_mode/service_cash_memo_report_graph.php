...
if(isset($_POST['from']))
{
$sr="SELECT sum(bill_amount) as y ,date as label FROM service_cash_memo where date between '".$_POST['from']."' AND '".$_POST['to']."' group by date";
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content-header">
       <h1>
  Service Cash Memo Sales Graph
        <small>Report</small>
      </h1>      
	   
    </section>
 <form role="form" method="post" action="service_cash_memo_report_graph.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
