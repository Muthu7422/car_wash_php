...
$dt=0;
$trs=0;
$gt1="select * from service_cash_memo_details where service_cash_memo_no='".$_REQUEST['service_cash_memo_no']."'";
...
$rpm1="select * from cash_memo where service_cash_memo_no='".$_REQUEST['service_cash_memo_no']."'";
