      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="purchase_reports_process.php" autocomplete="off">
              <div class="box-body">
        ...
        <div class="col-md-12">
            ...
            <!-- /.box-header -->
               <div class="box-body">
				...
				{
				$i=0;
				$ss="select * from s_purchase where pdate between '".$_REQUEST['from']."' and '".$_REQUEST['to']."' and status='Active' and FranchiseeId='".$_SESSION['BranchId']."'";
				$Ess=mysqli_query($conn,$ss);
				while($FEss=mysqli_fetch_array($Ess))
				{
					
					$pqr1="select * from s_purchase_details where inv_no='".$FEss['id']."'";
					$pqrs1=mysqli_query($conn,$pqr1);
					$poq1=mysqli_fetch_array($pqrs1);


	                $pqr2="select * from m_spare where sid='".$poq1['spare_name']."'";
					$pqrs2=mysqli_query($conn,$pqr2);
					$poq2=mysqli_fetch_array($pqrs2);

					$pqr="select * from m_supplier where sid='".$poq1['supplier_name']."'";
					$pqrs=mysqli_query($conn,$pqr);
					$poq=mysqli_fetch_array($pqrs);	
					
				

					$spm="select * from m_spare_brand where sid='".$poq1['spare_brand']."'";
                ...
                <tr>
				  ...
				  <td><?php echo $ids['sbrand'];?></td>
				  <td><?php echo $poq2['sname'];?></td>
				  <td><?php echo $poq1['purchase_rate'];?></td>
				  <td><?php echo $poq1['qty'];?></td>
				  <td><?php echo $poq1['gst_amt'];?></td>
				  <td><?php echo $poq1['total_amount'];?></td>
				  <?php
				  }
				}
				  ?>
