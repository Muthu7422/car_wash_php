    ...
    <section class="content container-fluid">
	  ...
	  <div class="row">
        ...
        <div class="col-md-12">            
		 ...
		 $tdate=$_POST['to'];
           ?>				
               <h4>  GST Report From <?php echo date("d-m-Y",strtotime($fdate)); ?>  To  <?php echo date("d-m-Y",strtotime($tdate)); ?> </h4>      
                </thead>
                ...
                <tr>
				  ...
				  <td><?php echo $cust_namef['cust_name']; ?></td>
				    <td><?php echo number_format($FEss['Total_bill_Amount'],2); ?></td>
				    <td><?php echo number_format($FEss['gst_amt'],2); ?></td>
