      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="gst_report_print.php" autocomplete="off" target="_blank">
              <div class="box-body">
			...
			<div>
			  <form class="form-horizontal" method="post" action="gst_export.php" autocomplete="off">
              ...
              <div class="box-footer">
                ...
                <button  type="submit" class="btn btn-info pull-right" >EXPORT GST Report To EXCEL </button>
              </div>
              <!-- /.box-footer -->
            </form>
		</div>
