 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content-header">
      <h1>
        Over all Ledger Payment Reports
        <small>Reports</small>
      </h1>
     </section>
<script>
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Over all Ledger Payment Reports</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
		
            <form class="form-horizontal" method="post" action="ledger_payment_report_print.php" autocomplete="off" target="_blank">
              <div class="box-body">
               ...
               <div class="form-group col-sm-4" style="padding-left:60px">
				 ...
				 <div class="form-group col-sm-4" style="padding-left:60px">
                  <label for="duedate">Ledger Name</label>
                 <select name="LedgerId" class="form-control pull-right" id="LedgerId" onKeyPress="return tabE(this,event)" required>
				 <option vale="">---Select Ledger Name--</option>
				 <?php
				 $lid="select * from a_customer where status='Active' and FrachiseeId='".$_SESSION['BranchId']."'";
				 $lidq=mysqli_query($conn,$lid);
				while($lidf=mysqli_fetch_array($lidq))
				{
				 ?>
				 <option value="<?php echo $lidf['LedgerId']?>"><?php echo $lidf['cust_name']?></option>
				<?php
				}
				?>
				 </select>
