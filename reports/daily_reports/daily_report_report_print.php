...
<tr>
			    ...
			    $scopEX2="select SUM(camount) as camount from a_hand_over_cash where CDate='$FromDate'";
			    ...
			    $scopEX1="select SUM(camount) as camount from a_hand_over_cash where CDate='$FromDate' and status='Active'";
