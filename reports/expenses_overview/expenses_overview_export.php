...
if(isset($_POST['sub_yaer']))
{
	...
	header("location:expenses_overview.php?fromyear=$fromyear");
}
...
<body>
     <table id="example1" class="table table-bordered table-striped" width="100%">
                <thead>
				 ...
				 <tr><h4>Expenses Overview - <?php echo $_POST['fromyear']; ?></h4></tr>
		...
		$j=0;
		$i=0;
			$expense="select DISTINCT(ExpenseType) as ExpenseType,Id from expense_master where franchisee_id='".$_SESSION['BranchId']."'";
