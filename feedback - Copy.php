...
<?php
		...
		$ji=mysql_query($j);
		$jiq=mysql_fetch_array($ji);
		$nosa=mysql_num_rows($ji);
    ...
    <section class="content container-fluid">
		...
		<center><i class="fa fa-map-marker fa-1.5x"  style="color:green" ><font color="black" style="font-size:18px;"> Prozone Mall, Coimbatore - 641035</font></i><span style="padding-left:35px"></span></center>
 				<hr>		
		<h2>Overall experience with our service</h2>
		<section class="content container-fluid">
		<div class="row">
		 <div class="col-sm-6"><h4>1. How would you rate our customer friendliness?</h4></div>
		...
		<div class="row">
		<div class="col-sm-6"><h4>2. Kindly rate the exterior cleanliness of your car</h4></div>
		<div class="col-sm-6">
		<h4>
		<br>
		 &nbsp;
		...
		<div class="row">
		<div class="col-sm-6"><h4>3. If service provided, kindly rate the interior cleanliness of your car</h4></div>
		...
		<div class="row">
		<div class="col-sm-6"><h4>4. If car detailing was provided, kindly rate the quality of the service</h4></div>
		...
		<div class="row">
		<div class="col-sm-6"><h4>5. Kindly rate the cleanliness of our facilities</h4></div>
		...
		<div class="rates">
			...
			<div class="row">
		<div class="col-sm-6"><h4>6. How would you rate the quality of vacuuming</h4></div>
		...
		<div class="rates">
			...
			<div class="row">
		<div class="col-sm-6"><h4>7. Would you recommend us to your friends & family?</h4></div>
		...
		<div class="row">
		<div class="col-sm-6"><h4>8. Overall, how would you rate the services provided to you?</h4></div>
		...
		<div class="rates">
			...
			<div class="row" >
		<div class="col-sm-1"><h4>Comments?</h4></div>
		
		<div class="col-sm-5">
			<h4>
		
					<textarea type="text" id="Comments" class="form-control" name="Comments" rows="3"></textarea>
					</h4>
		...
		<div class="row">
		<div class="col-sm-2"><i class="fa fa-phone fa-1.5x"  style="color:red" ><font color="black" style="font-size:18px;"> 8870 6888 77</font></i><span style="padding-left:35px"></span></div>
	   <div class="col-sm-2"><i class="fa fa-envelope fa-1.5x"  style="color:black" ><font color="black" style="font-size:18px;"> protouchcbe@gmail.com</font></i><span style="padding-left:35px"></span></div>
       <div class="col-sm-2"><a href="http://www.protouch.co.in/"><i class="fa fa-globe fa-1.5x"  style="color:black" ><font color="black" style="font-size:18px;"> www.protouch.co.in</font></i></a></div>
		<div class="col-sm-2"><i class="fa fa-whatsapp fa-1.5x"  style="color:green" ><font color="black" style="font-size:19px;"> 8870688877</font></i><span style="padding-left:35px"></span></div>
		<div class="col-sm-2"><a href="https://www.instagram.com/protouchindia/"><i class="fa fa-instagram fa-1.5x"  style="color:red" ><font color="black" style="font-size:19px;">/ protouchindia</font></i></a><span style="padding-left:35px"></span></div>
        <div class="col-sm-2"><a href="https://www.facebook.com/ProTouchIndia/"><i class="fa fa-facebook-square fa-1.5x"  style="color:blue" ><font color="black" style="font-size:19px;">/ protouchindia</font></i></a></div>
		</div>
...
<a href="http://www.vertexsolution.co.in/"><i class="fa fa-globe fa-1.5x"  style="color:black" ><font color="black" style="font-size:18px;">Your Feedback Is Expired</font></i></a>
<?php
