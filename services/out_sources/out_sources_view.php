        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-header">
              <h3 class="box-title">Painting Details</h3>
            </div>
              <div class="box-body">
                ...
                <tbody>
               	...
               	<?php
				$ct="select * from s_outsources where FranchiseeId='".$_SESSION['FranchiseeId']."' and Status=''";
				$Ect=mysqli_query($conn,$ct);
				 $n=mysqli_num_rows($Ect);
				$i=0;
				while($Fct=mysqli_fetch_array($Ect))
				{
				  $ssc="select * from s_job_card where id='".$Fct['JobcardId']."' and  FranchiseeId='".$_SESSION['FranchiseeId']."'";  
                ...
                <tr>
                  <td><?php echo $i;  ?></td>
                  <td><?php echo $FEssc['job_card_no'];  ?></td>
				  <td><?php echo $FEssc['sname']; ?></td>
				  <td><?php echo $Fct['OutsourcesDate']; ?></td>
				  <td><?php echo $FEssc['vehicle_no']; ?></td>
				  <td><?php echo $FEssc['smobile']; ?></td>
				  <td><?php echo $Fct['Note']; ?></td>
				 
				  <?php
				  if($Ews['jcard_status']!='Close')
				  {
				  ?>
				  <td><a href="out_sources_edit.php?job_card_no=<?php echo $Fct['job_card_no']; ?>&&JobcardId=<?php echo $Fct['JobcardId']; ?>&&OutsourcesId=<?php echo $Fct['Id']; ?>" onClick="return confirm('Are You Sure Want to Edit?');" class="btn-box-tool"><i class="fa fa-edit custom-icon1"></i></a></td>
				  <td><a href="out_sources_delete.php?job_card_no=<?php echo $Fct['job_card_no']; ?>&&JobcardId=<?php echo $Fct['JobcardId']; ?>&&OutsourcesId=<?php echo $Fct['Id']; ?>" onClick="return confirm('Are You Sure Want to Delete?');" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a></td>
				  <?php
				  }
				  else
				  {
