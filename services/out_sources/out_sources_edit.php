...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="outsources_editQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			?>
			  ...
			  <div class="hidden">
                <div class="form-group col-sm-4">
				  ...
				  <input type="text" class="form-control" name="OutsourcesId" id="OutsourcesId" value="<?php echo $_REQUEST['Id'];?>" readonly="true" required>
                </div>
				 </div>
				 <div class="form-group col-sm-4">
				  ...
				  <input type="hidden" class="form-control" name="Id" id="Id" value="<?php echo $_REQUEST['Id'];?>" readonly="true" required>
                </div>
				...
				<?php 
				$i=0;
				 $s="select * from s_outsources_details where JobcardId='".$_REQUEST['JobcardId']."'";
				...
				<td><a href="outsources_editQ.php?Act=Del&&JobcardId=<?php echo $FEs['JobcardId']; ?>&&Id=<?php echo $FEs['Id']; ?>&&job_card_no=<?php echo $_REQUEST['job_card_no']; ?>&&OutsourcesId=<?php echo $_REQUEST['OutsourcesId']; ?>" onClick="return Delete_Click();" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a></td>
                </tr>
				<?php 
				}
				}
			...
			<?php
		 	$Pom="select * from s_outsources where Id='".$_REQUEST['OutsourcesId']."'";
			$Edw=mysqli_query($conn,$Pom);
			$Swq=mysqli_fetch_array($Edw)
			...
			?>
				...
				<div class="form-group col-sm-4">
                  <label for="Branch">Date</label>
                  <input type="date" class="form-control" name="OutsourcesDate" id="OutsourcesDate" value="<?php echo $Swq['OutsourcesDate'];  ?>" required>
				   <input type="hidden" class="form-control" name="OutsourcesId" id="OutsourcesId" value="<?php echo $Swq['Id'];?>" readonly="true" required>
                </div>
					<div class="form-group col-sm-4">
			    <label for="catname">Painter Name</label>
                <select class="form-control" name="PainterName"  id="PainterName"   required>
				<?php
				$mob1="select * from m_painters_master where status='Active' and Id='".$Swq['PainterName']."'";
				$mobi1=mysqli_query($conn,$mob1);
				$Pain=mysqli_fetch_array($mobi1);
				?>
                ...
                <textarea class="form-control" name="Note" id="Note"  placeholder="Note"><?php echo  $Swq['Note'];  ?></textarea>
                </div>
				 </div>
              <!-- /.box-body -->
          </div>
          <!-- /.box -->
				  ...
				  <div class="box-body">
				   <div class="box-footer">
				 <div class="form-group col-sm-16">
                  <input type="submit" class="btn btn-info pull-right" name="Finish" id="Finish" value="Finish The Outsources">
                </div> </div>
				 </div>
