...
$.ajax({
	...
	var mrp = document.getElementById("TRate").value;
	 ...
	 var hra = parseFloat((mrp*quantity));
	 document.getElementById("tamount").value = hra.toFixed(2); 
	 }
...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="s_spare_prepick_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
			  ...
			  <div class="hidden">
				...
				<div class="form-group col-sm-4">
                  ...
                  <select class="form-control" id="sname" name="sname" onChange="getmrp();gettax();"onKeyUp="">
				  </select>
                </div>
				<div class="form-group col-sm-4">
				...
				<div class="form-group col-sm-4">
                  ...
                  <button  type="submit" class="btn btn-info pull-right" onClick="return confirm('Are you Sure Want to Proceed ?')">Add</button>
				...
				<th style="width:100px">Spare Rate</th>
				...
				<?php 
				$i=0;
				 $s="select * from s_spare_prepick_temp where s_job_card_no='".$_REQUEST['job_card_no']."' and JobcardId='".$_REQUEST['JobcardId']."' and FranchiseeId='".$_SESSION['FranchiseeId']."' and status='Active'";
				...
				while($FEssc=mysqli_fetch_array($Essc))
				  {
					...
					$tax=$FEssc['TaxRate'];
					$taxper=$tax+100;
				$taxamt=($FEssc['TaxRate']/$taxper)*$mrp;
				$Rate=$mrp-$taxamt;
				...
				<td align="right" style="padding-right:2px"><?php echo number_format($Rate,2);  ?></td>
				<td align="center"><?php echo number_format($FEssc['TaxRate'],0);  ?> %</td>
				<td align="right" style="padding-right:2px"><?php echo $mrp;  ?></td>
				<td><?php echo $FEs['qty'];  ?></td>
				<td align="right" style="padding-right:2px"><?php echo number_format($FEs['total'],2);  ?></td>
				<td><a href="s_spare_prepick_delete_temp.php?job_card_no=<?php echo $FEs['s_job_card_no']; ?> && JobcardId=<?php echo $FEs['JobcardId']; ?>&&id=<?php echo $FEs['id']; ?>" onClick="return Delete_Click();" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a></td>
                </tr>
				<?php 
				}
				}
	    ...
	    <div class="box-footer">
                ...
                <button  type="submit" class="btn btn-info pull-right" onclick="return confirm('Are You Sure Want to Proceed?');">Submit Spares</button>
                </div>    
         </div>
