...
$abc="select * from a_customer_vehicle_details where FrachiseeId='".$_SESSION['BranchId']."'";
...
while($ac=mysqli_fetch_array($abcd))
{
 ...
 $abc1="select * from a_customer_vehicle_details where FrachiseeId='".$_SESSION['BranchId']."'";
...
//$od="select * from customer_old_data where CustomerName!='' AND ServiceDate!='0000-00-00'";
$od="select FrachiseeId as id,mobile1 as Mobile from a_customer where FrachiseeId='".$_SESSION['BranchId']."' UNION SELECT FrachiseeId as id,mobile2 as Mobile FROM a_customer where FrachiseeId='".$_SESSION['BranchId']."'";
...
// {
	...
	// $OldCustomer.="'".$FEod['CustomerMobile']."',";
// }
 // $OldCustomer.="'']";
    ...
    <form role="form" method="post" action="s_jobcard.php?temp=del"  autocomplete="off">
      <div class="row">
		...
		<br>
			 ...
			 <input type="text" class="form-control" style="display: none" name="smobile"  id="smobile"  autocomplete="off" style="text-transform:uppercase" onKeyPress="return tabE(this,event)"  placeholder="Customer Mobile No">
...
autocomplete(document.getElementById("smobile"), OldCustomers);
