          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <tbody>
					<?php
				$ss="select SecretPin,jcard_status,job_card_no,id,CustomerSignature,jdate,vehicle_no,sname,smobile from s_job_card where status='Active' and FranchiseeId='".$_SESSION['FranchiseeId']."' and jcard_status!='Close' and jdate='".date('Y-m-d')."' and jcard_status='Ready To Delivery' order by id desc";
