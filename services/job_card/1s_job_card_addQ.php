...
$message="Dear Customer ".$ref.".".$v.", your Vehicle ".$a."is under the service,It is Scheduled to deliver on ".$c."  ".$d.".Invoice Amount is Rs.".$b."/-. Please share this ".$e." secret pin number if You are only satisfied with our service.Thanks";
// SMS content Start //
