 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content-header">
      <h1>
       Job Card History|<a href="s_jobcard_close_all.php" target="_blank">View All</a>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <tbody>
					<?php
				//$ss="select * from s_job_card where status='Active' and FranchiseeId='".$_SESSION['FranchiseeId']."' and jcard_status='Close'";
			   // $ss="select * from s_job_card where  jdate >= DATE_SUB(CURDATE(), INTERVAL 1 DAY) and jcard_status='Close' Order by job_card_no DESC";
				$ss="select * from s_job_card where  `jdate` >= DATE_SUB(CURDATE(), INTERVAL 5 DAY) AND jcard_status='Close' AND FranchiseeId='".$_SESSION['BranchId']."'  ORDER BY job_card_no DESC";
                ...
                <tr>
				  ...
				  <td align="center"><a href="../../store/final_bill/final_receipt.php?inv_no=<?php echo $dsa['inv_no']; ?>&&JobcardId=<?php echo $FEss['id']; ?>" target="_blanck"  onclick="return confirm('Are You Sure Want to View the Job Card?');" class="btn-box-tool"><i class="fa fa-print" style="font-size:20px;color:red"></i></a></td>
					 <td><a href="pdftomail/index.php?job_card_no=<?php echo $FEss['job_card_no']; ?>" Title="Send Mail" class="btn-box-tool" target="_blank"><i class="fa fa-envelope custom-icon1" style="font-size:20px;color:brown"></i></a></td>
				  <?php
				  }
