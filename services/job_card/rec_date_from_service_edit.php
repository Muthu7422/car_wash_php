      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="service_temp_reco_edit.php?id=<?php echo $FEs['id']; ?> && job_card_no=<?php echo $FEs['job_card_no']; ?> && mobile=<?php echo $temp['smobile'];?> " autocomplete="off">
              <div class="box-body">
                  <div class="hidden">
                <div class="form-group">
				  ...
				  $sdetails="select * from s_job_card_sdetails where id='$job_card_no'";
                 $sdetailssql=mysqli_query($conn,$sdetails);
                 $sd=mysqli_fetch_array($sdetailssql);
				 
				  $sdetails11="select * from s_job_card where id='$job_card_no'";
                 $sdetailssql1=mysqli_query($conn,$sdetails11);
                 $sd1=mysqli_fetch_array($sdetailssql1);
	  ...
	  ?>
				...
				<div class="hidden">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
					   <input type="text" class="form-control" name="job_card" id="job_card" value="<?php echo $sd1['job_card_no']; ?>"  readonly="true">
                        <input type="text" class="form-control hidden" name="job_card_no" id="job_card_no" value="<?php echo $job_card_no; ?>"  readonly="true">
                ...
                <div class="form-group">
					...
					<?php
					 $s="select * from s_job_card_sdetails where job_card_no='".$_REQUEST['job_card_no']."' and id='".$_REQUEST['id']."'"; 
