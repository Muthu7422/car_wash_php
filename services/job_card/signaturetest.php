...
<div>
<?php
//$jc=$_REQUEST['job_card_no'];
$jc="F1-1";
            $nm="select * from s_job_card where job_card_no='$jc'";
	...
	$mobil=mysqli_fetch_array($mobi);
			...
			?>
			   ...
			   <label for="catname">Date</label>
                ...
                ?>				
				<div><img src="data:<?php echo $pngdata; ?>" width="250px" height="80px" /></div>
				</div>
