...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="s_job_card_open_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
			 ...
			 <input type="text" class="form-control" name="smobile" value="<?php echo $temp['smobile'];?>" id="smobile" onKeyPress="return tabE(this,event)"  placeholder=" Mobile No" readonly="true">
               ...
               <div class="col-sm-2">
                  ...
                  <input type="Submit" placeholder="Add" style="background-color:#37B8F8;color:#000000" value="Open Job Card"  class="form-control" onclick="return confirm('Are You Sure Want to Open Job Card?');" >
                </div>
				  </div>
				</div>
