            ...
            <!-- form start -->
              ...
              <div class="box-body">
				...
				<div class="form-group col-sm-4">
				  ...
				  $rps1=mysqli_query($conn,$rpm1);
				  $spu1=mysqli_fetch_array($rps1);
				...
				<div class="form-group col-sm-4">
                  ...
                  <select class="form-control" id="customer_name" name="customer_name" onChange="amcep(this.value);" required>
				  <?php
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Item Purchase Details</h3>
				...
				<input type="text" name="<?php echo "total_amount".$i;  ?>" id="<?php echo "total_amount".$i; ?>" value="<?php echo $FEssd['total_amount']; ?>"  onKeyUp="getamount(<?php echo $i;?>);gettotal(<?php echo $i;?>)"  onKeyPress="return tabE(this,event)" class="form-control" readonly>
					</td>
					<td style="width:  100px">
					<input type="text" name="<?php echo "qty".$i; ?>" id="<?php echo "qty".$i;?>" value="<?php echo $FEssd['qty']; ?>" onKeyUp="getamount(<?php echo $i;?>);gettotal(<?php echo $i;?>)"  class="form-control">
					</td>
					<td style="width:  100px">
					<input type="text" name="<?php echo "installation_amt".$i; ?>" id="<?php echo "installation_amt".$i;?>" value="<?php echo $FEssd['service_amount']; ?>" onKeyUp="getamount(<?php echo $i;?>);" placeholder="Service Amount" onKeyPress="return tabE(this,event)" class="form-control" readonly>
