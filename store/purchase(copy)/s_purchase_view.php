 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <?php  if($FEspno['CreateData']>'0')
					  {
					  ?>
       <h4><div align="right"><a href="s_purchase.php"><b> CREATE NEW PURCHASE</b></a></div></h4>  
 <?php } ?>	  
	  <!-- left column -->
        ...
        <div class="col-md-12">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<td><a href="<?php  echo "image/".$Fct['PurchasePhoto']; ?>" target="_blank"><?php echo $Fct['PurchasePhoto'];?></a></td>
