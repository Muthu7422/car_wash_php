...
//index.php
mysql_connect("198.71.227.89","autodetailerz","fHap470~");
...
//$connect = new PDO("mysql:host=localhost;dbname=autodetailerz", "root", "");
$connect = new PDO("mysql:host=198.71.227.89;dbname=autodetailerz", "autodetailerz", "fHap470~");
...
<td align="left" colspan="1">&nbsp;&nbsp;<b>'.$Fs1['other_charge'].'</b></td>
</tr>';
...
<td align="left" colspan="1">&nbsp;&nbsp;<b>'.$dis.'</b></td>
</tr>';
...
<td align="left" colspan="1">&nbsp;&nbsp;<b>'.round($gst,2).'</b></td>
</tr>
<tr>
<td colspan="2"></td>
<td  align="right" colspan="2" height="30px"><b>BILL AMOUNT:</b> &nbsp;&nbsp;</td>
<td align="left" colspan="1">&nbsp;&nbsp;<b>'.round($Fs1['bill_amt'],0).'.00</b></td>
</tr>
<tr>
<td colspan="2"></td>
<td  align="right" colspan="2" height="30px"><b>ADVANCE AMOUNT:</b> &nbsp;&nbsp;</td>
<td align="left" colspan="1">&nbsp;&nbsp;<b>'.$Fs1['paid_amt'].'</b></td>
</tr>';
$output.=
'<tr>
<td colspan="2"></td>
<td  align="right" colspan="2" height="30px"><b>PREMIUM PACKAGE AMOUNT:</b> &nbsp;&nbsp;</td>
<td align="left" colspan="1">&nbsp;&nbsp;<b>'.$Fs1['from_off_amt'].'</b></td>
</tr>';
