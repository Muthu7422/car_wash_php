...
<tr>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >S:no</FONT></td>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >Service Name</FONT></td>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >HSN Code</FONT></td>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >Amount</FONT></td>
</tr>
...
$i=0;
			...
			$sdm5="select *from m_service_type where stype='".$dcm1['service_type']."'"; 
			$scm5=mysqli_query($conn,$sdm5);
			$dcm5=mysqli_fetch_array($scm5);
				
			$sdm6="select *from m_service_type_details where service_type='".$dcm5['id']."'"; 
			$scm6=mysqli_query($conn,$sdm6);
			$dcm6=mysqli_fetch_array($scm6);
$i++;
?>
<tr>
<td><?php echo $i; ?></td>
<td><?php echo $dcm1['service_type']; ?></td>
<td><?php echo $dcm6['hsn_code']; ?></td>
...
<td></td></tr>
<tr hidden>
<td align="left"  height="10px"><b>Accessories Details :</b></td>
</tr>
<tr>
<td>
...
<tr hidden>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >S:no</FONT></td>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >Accessories Name</FONT></td>
<td bgcolor="#757978"><FONT COLOR='FFFFFF' align="center" >Amount</FONT></td>
</tr>

<?php
$i=0;
			$sdm1="select *from s_jobcard_accesories_main where job_card_no='".$Fs['job_card_no']."'"; 
			$scm1=mysqli_query($conn,$sdm1);
			$dcm1=mysqli_fetch_array($scm1);
			
				$sdm12="select *from m_spare where sid='".$dcm1['sname']."'"; 
			$scm12=mysqli_query($conn,$sdm12);
		while(	$dcm12=mysqli_fetch_array($scm12)){

$i++;
?>
<tr hidden>
<td><?php echo $i; ?></td>
<td><?php echo $dcm12['sname']; ?></td>
<td><?php echo $dcm1['smrp'];?></td>
</tr>
<?php 
}
...
$i=0;
			...
			$sdm5="select *from m_service_type_details where service_type='".$dcm['id']."'"; 
			$scm5=mysqli_query($conn,$sdm5);
			$dcm5=mysqli_fetch_array($scm5);
...
$Fs1=mysqli_fetch_array($Egt1);
  ...
  $gt12="select * from s_job_card where job_card_no='".$Fs1['job_card_no']."'"; 
...
<tr>
<td class="style4">3.Disputes if any subject to <b><?php echo $Frp1['city']; ?></b></td>
...
<td><b>Accessories Amount</b></td>
<td width="25"><b> :</b></td>
<td align="right"><b><?php echo number_format($Fs12['acc_t_amt'],2);?></b></td>
</tr>
<tr hidden>
<td class="style4"></td>
...
<h4 align="right"><b><?PHP echo $Frp1['franchisee_name']; ?></b></h4>
