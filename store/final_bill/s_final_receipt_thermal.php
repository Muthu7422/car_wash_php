...
<table align="center" width="250" border="1"   cellpadding="3"  cellspacing="0">
  <thead>    
    <tr>
    <td align="left" width="350"><b><?PHP echo $Frp1['franchisee_name']; ?></b><br/><?PHP echo $Frp1['address']; ?><br/><?PHP echo $Frp1['con_number']; ?><br/>VAT:<?PHP echo  $Frp1['gst_no']; ?><?PHP echo $Frp1['website']; ?><br/><?PHP echo $Frp1['email']; ?> </td>
 </tr>
	<tr>
...
<table align="center" width="250" border="1px"   cellpadding="3"  cellspacing="0"> 
  <tr>
     <td align="left" width="112"><b>Date </b></td><td align="left" width="135"><b>Invoice No </b></td>
  </tr>
  <tr>
...
<table align="center" width="250" border="1px"   cellpadding="3"  cellspacing="0"> 
 ...
 <tr>
    <td align="left" width="250"><b> Job Card No </b><u><?php echo $FEsc['id']; ?></u></td><td align="left" width="100"><b>Vehicle No </b>&nbsp; &nbsp; </td>
 </tr>
 <tr>
   <td align="left" width="250"><?php echo $FEsij['job_card_no'] ?></td><td align="left" width="250"><?php echo $FEsij['cvehile'] ?></td>
 </tr>
 <tr>
    <td align="left" width="250"><b>State </b><u></u></td><td align="left" width="100"><?php echo $Frp11['jstate'] ?>&nbsp; &nbsp; </td>
 </tr>
 <tr>
 
   <td align="left" width="150"><b>Cust Name</b></td><td align="left" width="100"><b>Mobile</b></td>  
 </tr>
 <tr>
...
<tr>
   <td align="left"><b>Entry Time</b></td>
   <td align="left" ><?php echo $Frp11['entry_time'] ?></td>
   </tr>
   <tr>
    <td align="left"><b>Exit Time</b></td>
...
<table align="center" width="250" border="1px"   cellpadding="3"  cellspacing="0" >  
 ...
 <tr>
 <td>  <?php echo $i;?> </td>
 <td align="left" width="250"><?php echo $FEsij1['service_type'] ?></td><td align="left" width="250"><?php echo $FEsij1['st_amt']  ?></td>
 </tr>
...
<table align="center" width="250" border="1px"   cellpadding="3"  cellspacing="0">  
  <tr>
    <td align="left" width="150"><b>Amount </b></td><td align="right" width="250"><b><?PHP echo number_format($FEsij['TotalServiceAmount'],2); ?></b></td>
  </tr>
  <tr>
    <td align="left" width="100"><b>Discount Amount </b></td><td align="right" width="250"><b><?PHP echo $FEsij['discount']; ?></b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" width="100"><b>Total </b></td><td align="right" width="250"><b><?PHP echo number_format($FEsij['Total_bill_Amount'],2); ?></b></td>
  </tr>
  <tr>
    <td align="left" width="100"><b>Balance Amount </b></td><td align="right" width="250"><b><?PHP echo number_format($FEsij['bal_amt'],2); ?></b></td>
  </tr>
</table>
</td>
</tr>
