 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <?php  if($FEspno['CreateData']>'0')
					  {
					  ?>
       <h4 hidden><div align="right"><a href="sales_invoice.php"><b> CREATE NEW SALES ORDER</b></a></div></h4>  
 <?php } ?>	  
	  <!-- left column -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header">
              <h3 class="box-title">Available Invoices</h3>
            </div>
            <!-- /.box-header -->
				  <?php 
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$ct="select * from sales_order where FranchiseeId='".$_SESSION['BranchId']."' and purchase_details='Open' order by id desc";
				...
				<td> <a href="sales_invoice_receipt.php?inv_no=<?php echo $Fct['inv_no']; ?>"  class="btn-box-tool"><i class="fa fa-print custom-icon1" style="font-size:20px;color:brown"></i></a> </td>
