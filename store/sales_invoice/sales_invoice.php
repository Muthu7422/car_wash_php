...
echo  $p="select * from job_card_no where branch_id='".$_SESSION['BranchId']."'";
...
<script type="text/javascript">
    ...
    <form role="form" method="post" action="sales_invoice_temp_act_old.php" enctype="multipart/form-data" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			 ...
			 ?>
              ...
              <div class="box-body">
                <div class="form-group col-sm-4" hidden>
				  ...
				  <?php
				  $in="select * from s_quotation where q_no='".$_REQUEST['q_no']."'";
				  ...
				  $sem="select * from m_franchisee where branch_id='".$Fin['FrachiseeId']."'";
                  ...
                  <label for="Branch">Invoice No</label>
                  <input type="text" class="form-control" name="inv_no" id="inv_no" placeholder="Q NO" value="<?php echo $Ajon; ?>" onKeyPress="return tabE(this,event)" readonly >
                  <input type="hidden" class="form-control" name="q_no" id="q_no" placeholder="Q NO" value="<?php echo $_REQUEST['q_no']; ?>" onKeyPress="return tabE(this,event)" readonly >
                 </div>
				...
				<div class="form-group col-sm-4">
				  ...
				  <option value="<?php echo $_SESSION['Branch_id']; ?>"><?php echo $_SESSION['franchisee_name']; ?></option>
			  	  <?php 
				  $ssc="select * from m_franchisee where status='Active' and  branch_id='".$_SESSION['franchisee_name']."'";
			...
			<div class="box-footer">
			 ...
			 <div class="row">
                ...
                <tbody>
				<?php
				$ss="select * from  s_quotation_details where q_no='".$Fin['id']."' order by id";
				...
				<td><?php  echo $FEss['total']; ?></td>
				 ...
				 <td ><a href="sales_invoice_popup.php?id=<?php echo $FEss['id']; ?>" class="btn-box-tool"><i class="fa fa-edit custom-icon1"></i></a></td>
				  <td>
				  <a href="sales_invoice_delete_temp.php?id=<?php echo $FEss['id']; ?> && q_no=<?php echo $FEss['q_no']; ?>" Onclick="return confirm('Are you sure want to proceed?')" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a></td>
				...
				<?php } ?>
				 ...
				 <?php 
				  $sdm="select * from s_quotation_details where q_no='".$Fin['id']."'"; 
					$scm=mysqli_query($conn,$sdm);
					while($pqr=mysqli_fetch_array($scm))
					{
						$ta=$ta+$pqr['total_amount'];
					}
			...
			<div class="form-group col-sm-4">
				...
				<div class="form-group col-sm-4">
                  ...
                  <select type="text" class="form-control" name="payment_mode" id="payment_mode"  onchange = "ShowHideDiv();">
		...
		<?php
			 ...
			 <div class="form-group col-sm-4 ">
                  ...
                  <input type="text" class="form-control" name="BCash" id="BCash" value="<?php  echo $OB; ?>" readonly>
		...
		<?php
				...
				?>
			 <div class="form-group col-sm-4 ">
                  <label for="Branch">Available Balance Amount in Bank</label>
                  <input type="text" class="form-control" name="BCashb" id="BCashb" value="<?php echo $OB;?>" readonly>
				  </div>
				<?php } ?>				  
				</div>
				<div class="form-group col-sm-4">
