...
//sender
$from = 'audit@tyresmart.in';
$fromName = 'autodetailerz.com';

//email subject
$subject = 'Purchase Order  from Auto Detailerz'; 
...
//email body content
$htmlContent = '<p>Hi,Please Find Purchase Order details in attached PDF File.</p>';
