...
{
 $pm="insert into s_purchase_order_temp set FrachiseeId='".$_SESSION['FranchiseeId']."',inv_no='".strtoupper($_POST['inv_no'])."',pdate='".$_POST['pdate']."',supplier_name='".$_POST['supplier_name']."',outstand='".$_POST['out']."'";  
...
{
	$rpe1="select * from s_purchase_order where inv_no='".$_POST['inv_no']."'";  
$rpm1=mysqli_query($conn,$rpe1);
$spm1=mysqli_fetch_array($rpm1);



	$dwp="delete from s_purchase_order where inv_no='".$_POST['inv_no']."'";
	$Edc=mysqli_query($conn,$dwp);
	
	$dwp="delete from s_purchase_order_details where inv_no='".$spm1['id']."'";
	$Edc=mysqli_query($conn,$dwp);
...
$Fpm1=mysqli_fetch_array($Epm1);
		...
		$pm2="insert into s_purchase_order set inv_no='".$_POST['inv_no']."',pdate='".$Fpm1['pdate']."',supplier_name='".$Fpm1['supplier_name']."',outstand='".$Fpm1['outstand']."',status='Active',purchase_details='Open',description='".$_POST['description']."',franchisee_id='".$var['branch_id']."',vendor_id='".$var1['vendor_id']."'";
