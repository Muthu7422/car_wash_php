...
$.ajax({
      type:'post',
       ...
       data:{inputs},
        ...
        document.getElementById("gstin").value=msg[1];
...
function sumpurchase()
{
	...
	var mrp= parseFloat(document.getElementById("purchase_rate").value);
	...
	var total=mrp*+qty;
		document.getElementById("total").value=total.toFixed(2);
			 ...
			 if($_REQUEST['purchase_order']!="")
			 {
			 $Ajon=$_REQUEST['purchase_order'];
			 }
			 else
			 {
			 $Ajon=$pn; 
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group col-sm-4">
				  ...
				  ?>
                  <input type="text" class="form-control" name="inv_no" id="inv_no" value="<?php echo $Ajon; ?>" placeholder="Purchase order No" required readonly>
               ...
               <select class="form-control"  id="sparename" name="sparename" onChange="spare_mrp(this.value);spare_unit(this.value);spare_part(this.value);hsn_code(this.value);">
               ...
               <select class="form-control"  id="unit" name="unit">
				...
				<div class="form-group col-sm-2">
                  ...
                  <input type="text" class="form-control" name="purchase_rate" id="purchase_rate" onKeyUp="sumpurchase();" placeholder="Purchase Rate">
				...
				<div class="form-group col-sm-2 hidden">
                  <label for="Branch">Purchase Rate</label>
                  <input type="text" class="form-control" name="purchase_rate1" id="purchase_rate1" onKeyUp="sumpurchase();" readonly>
                </div>
				<div class="form-group col-sm-2">
			...
			<div class="box-footer">
			 ...
			 <div class="box-body">
                ...
                <tbody>
				<?php
				$ss="select * from  s_purchase_order_details_temp where franchisee_id='".$_SESSION['BranchId']."'";
