...
{
echo	$Rcm="insert into s_purchase_order_details set inv_no='$Ed',supplier_name='".$edi['supplier_name']."',spare_brand='".$edi['spare_brand']."',spare_name='".$edi['spare_name']."',spare_part_no='".$edi['spare_part_no']."',hsn_code='".$edi['hsn_code']."',unit='".$edi['unit']."',mrp='".$edi['mrp']."',discount_per='".$edi['discount']."',discount_amt='".$edi['discount_amt']."',purchase_rate='".$edi['purchase_rate']."',qty='".$edi['qty']."',total='".$edi['total']."',gst='".$edi['gst']."',gst_amt='".$edi['gst_amt']."',total_amount='".$edi['net_amount']."',status='Active',purchase_status='Pending'";
	$Edm=mysqli_query($conn,$Rcm);

}

$p="update job_card_no set purchase_order=purchase_order+1 where branch_id='".$_SESSION['BranchId']."'"; 
