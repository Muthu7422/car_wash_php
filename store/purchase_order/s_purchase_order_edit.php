            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group col-sm-4">
				  ...
				  <?php
				  $in="select * from s_purchase_order_temp where inv_no='".$_REQUEST['inv_no']."'";
				  ...
				  $sem="select * from m_franchisee where franchisee_id='".$Fin['FranchiseeId']."'";
				  $arr=mysqli_query($conn,$sem);
				  $spm=mysqli_fetch_array($arr);
				  
				  $sem1="select * from m_vendor where vendor_id='".$_SESSION['VendorId']."'";
				  $arr1=mysqli_query($conn,$sem1);
				  $spm1=mysqli_fetch_array($arr1);
				 
				 
				  $in1="select * from s_purchase_order where inv_no='".$_REQUEST['inv_no']."'";
			...
			<div class="box-footer">
			 ...
			 <div class="box-body">
				...
				<td><?php  echo $FEss['total']; ?></td>
				  <td>
				  <a href="s_purchase_order_delete_temp_edit.php?id=<?php echo $FEss['id']; ?> && inv_no=<?php echo $FEss['inv_no']; ?>" Onclick="return confirm('Are you sure want to proceed?')" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a></td>
