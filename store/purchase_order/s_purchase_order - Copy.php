...
function sumpurchase()
{
    ...
    <form role="form" method="post" action="s_purchase_order_act.php" autocomplete="off">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			<div class="box-footer">
                <button type="submit" Onclick="return confirm('Are you sure want to proceed?')" class="btn btn-info pull-right">Save The Purchase Order</button>
                </div> 
	    ...
	    <div class="box-footer">
                <button type="submit" class="btn btn-info pull-right" Onclick="return confirm('Are you sure want to proceed?')">Submit The Purchase Order</button>
                </div>    
         </div>
