      ...
      <div class="row">
			...
			<div class="box-footer">
			 ...
			 <div class="row">
				...
				while($FEss=mysqli_fetch_array($Ess))
				{
					...
					$rtr=$FEss['total']-$FEss['discount_amt'];
				?>
                <tr>
                  <td><?php echo $i; ?></td>
				...
				<td><?php  echo number_format($rtr,2); ?></td>
				  ...
				  <td ><a href="purchase_popup.php?id=<?php echo $FEss['id']; ?>" class="btn-box-tool"><i class="fa fa-edit custom-icon1"></i></a></td>
		...
		<?php
			 ...
			 <div class="form-group col-sm-4 ">
                  ...
                  <input type="text" class="form-control" name="BCashb" id="BCashb" value="<?php echo $OB;  ?>">
				  </div>
				<?php } ?>				  
				</div>
				<div class="form-group col-sm-4">
