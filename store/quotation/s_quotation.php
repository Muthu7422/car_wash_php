        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              ...
              <div class="box-body">
                <div class="form-group col-sm-4" hidden>
				 ...
				 <div class="form-group col-sm-4">
                  ...
                  <input type="date" class="form-control" name="pdate" id="pdate" value="<?php echo date('Y-m-d'); ?>"  value="<?php echo $Fin['pdate']; ?>" placeholder="Date" required>
                </div>
				<div class="form-group col-sm-4" hidden>
				...
				<div class="form-group col-sm-4">
				  ...
				  <option value="<?php echo $_SESSION['BranchId']; ?>"><?php echo $_SESSION['franchisee_name']; ?></option>
			  	  <?php 
				  $ssc="select * from m_franchisee where status='Active' and branch_id='".$_SESSION['BranchId']."' ";
				...
				<option>--Select The Customer--</option>
				  <?php 
			echo	  $ssc="select * from a_customer where FrachiseeId='".$_SESSION['BranchId']."' AND status='Active'";
				  $Essc=mysqli_query($conn,$ssc);
				  while($FEssc=mysqli_fetch_array($Essc))
				  {
				  ?>
			...
			<div class="box-footer">
                <button type="submit" name="Add" id="Add" Onclick="return confirm('Are you sure want to proceed?')" class="btn btn-info pull-right">Save The Quotation</button>
                </div> 
		  ...
		  <div class="box-body">
	    <div class="box-footer">
                <button type="submit" class="btn btn-info pull-right" Onclick="return confirm('Are you sure want to proceed?')">Submit The Quotation</button>
                </div>    
         </div>  </div>
