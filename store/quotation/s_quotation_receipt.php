...
$date=date('d/m/Y');
 $s="select * from s_quotation where q_no='".$_REQUEST['q_no']."'"; 
...
<td align="center" width="175">Quotation No<br/>DATE</td>
<td align="left" width="50">: <br/>:</td>
<td align="left" width="125"><?php echo $Fs['q_no']; ?><br/><?php echo date("d-m-Y", strtotime($Fs['pdate'])); ?></td>
</tr>
...
<?php
  ...
  $agt="select * from s_quotation_details where q_no='".$Fs['id']."'"; 
 $i=0;
...
<?php
$btr="select * from s_quotation where q_no='".$_REQUEST['q_no']."'"; 
...
<h4 align="center"><input type="button" name="print" value="print" onClick="printDiv('print-content')" />&nbsp;&nbsp;&nbsp;<a href="s_quotation_view.php" class="button style2">Close</a></h4>
</body>
</html>
