...
function sumgst()
{
    ...
    <form role="form" method="post" action="sales_invoice_view.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
				 ...
				 <div class="form-group col-sm-4">
                  ...
                  <input type="date" class="form-control" name="date" id="date"  value="<?php echo $Fin['sdate']; ?>" placeholder="Date" required readonly>
                </div>
				...
				<div class="form-group col-sm-4">
                  ...
                  <select class="form-control" id="customer_name" name="customer_name" onChange="outstanding(this.value);" required readonly>
				  <?php 
				...
				<div class="form-group col-sm-4">
                  ...
                  <input class="form-control" name="out" id="out" readonly  placeholder="Outstanding" readonly >
                </div> 
				<div class="form-group col-sm-4">
                  <label for="Branch">Description</label>
                  <input class="form-control" name="description" id="description" placeholder="Description" readonly >
                </div></div>
            ...
            <div class="box-header">
              <h3 class="box-title">Item Purchase Details</h3>
                ...
                <tr>
				  ...
				  <th style="width:  100px">Purchase Rate</th>
                ...
                <tr>
					...
					<select name="<?php echo "spare_brand".$i; ?>" id="<?php echo "spare_brand".$i; ?>" onChange="getbrand(<?php echo $i; ?>);"  class="form-control" onkeypress="return tabE(this,event)" readonly>
					<?php
					...
					?>
					<td style="width:  250px">
					<select name="<?php echo "spare_name".$i; ?>" id="<?php echo "spare_name".$i ?>" onChange="getmrp(<?php echo $i; ?>);"  class="form-control" onkeypress="return tabE(this,event)" readonly>
				  ...
				  <td style="width:  100px">
					<input type="text" name="<?php echo "mrp".$i; ?>" id="<?php echo "mrp".$i;?>" value="<?php echo $FEssd['BeforeTaxOfMrp']; ?>" onKeyUp="getamount(<?php echo $i;?>);" placeholder="MRP" onKeyPress="return tabE(this,event)" class="form-control" readonly>
					</td>
					<td style="width:  100px">
					<input type="text" name="<?php echo "qty".$i; ?>" id="<?php echo "qty".$i;?>" value="<?php echo $FEssd['qty']; ?>" onKeyUp="getamount(<?php echo $i;?>);gettotal(<?php echo $i;?>)" onKeyPress="return tabE(this,event)" class="form-control" readonly>
					</td>
					<td style="width:  100px">
