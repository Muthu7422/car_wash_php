...
<tr>
<td align="left" width="350"><b><?PHP echo $Frp1['franchisee_name']; ?></b><br/><?PHP echo $Frp1['address']; ?><br/><?PHP echo $Frp1['con_number']; ?><?PHP echo $Frp1['website']; ?><br/><?PHP echo $Frp1['email']; ?></br><b>GST NO : </b><?PHP echo $Frp1['gst_no']; ?> </td>
</tr>
...
<tr>
<td align="left" width="350"><b>INVOICE TO</b><br/><?PHP echo $epm['cust_name']; ?><br/><?PHP echo $epm['addr']; ?>,<?PHP echo $epm['city']; ?></br><?PHP echo $epm['state']; ?>,<?PHP echo $epm['pincode']; ?><br/><?PHP echo $epm['mobile1']; ?><br/><?PHP echo $epm['email']; ?><br/><b>GST NO : </b><?PHP echo $epm['gst']; ?></td>
<td align="left" width="350"><b>SHIP TO</b><br/><?PHP echo $epm['s_cust_name']; ?><br/><?PHP echo $epm['s_addr']; ?>,<?PHP echo $epm['s_city']; ?></br><?PHP echo $epm['s_state']; ?>,<?PHP echo $epm['s_pincode']; ?><br/><?PHP echo $epm['s_mobile1']; ?><br/><?PHP echo $epm['s_email']; ?></td>
<td align="center" width="175">INVOICE NO <br/>DATE</td>
<td align="left" width="50">: <br/>:</td>
<td align="left" width="175"><?php echo $Fs['inv_no']; ?><br/><?php echo date("d-m-Y", strtotime($Fs['sdate'])); ?></td>
</tr>
...
<tr>
<td class="style4"><b>Bank Details : </b></td>
<td><b> Tax  </b></td>
<td width="25"><b> :</b></td>
...
<?php 
 $gt12="select * from a_bank_acc where default_acc='Yes' and franchisee_id='".$_SESSION['BranchId']."'"; 
$Egt12=mysqli_query($conn,$gt12);
$Fs12=mysqli_fetch_array($Egt12);

?>

<td class="style4"><b>Bank Name : </b><?php echo $Fs12['BankName']; ?></td>
<td><b> </b></td>
<td width="25"><b></b></td>
<td><b></b></td>
</tr>
...
<tr>
<td class="style4"><b>Account Name : </b><?php echo $Fs12['AccountName']; ?></td>
<td> </td>
<td width="25"><b> </b></td>
<td><b></b></td>
</tr>
...
<tr>
<td class="style4"><b>Account Number : </b><?php echo $Fs12['AccountNumber']; ?></td>
<td bgcolor=""><b></b></td>
...
<tr>
<td class="style4"><b>IFSC Code : </b><?php echo $Fs12['IFSCCode']; ?></td>
<td><b></b></td>
<td width="25"><b> </b></td>
<td><b></b></td>
</tr>
