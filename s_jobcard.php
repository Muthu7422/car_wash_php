...
include("../../redirect.php");
			...
			$absc=mysql_query($see);
			$var=mysql_fetch_array($absc);
...
$abcd=mysql_query($abc);
$mobile1="[";
while($ac=mysql_fetch_array($abcd))
{
	$mobile1.="'".$ac['mobile1']."',";
}
 $mobile1.="'']";
...
function getcolor(val) {
    ...
    window.open("show_items_list_pp.php?cname="+$val,"_blank","toolbar=no,top=200,left=500,width=350px,height=300,addressbar=no");
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
   ...
   <!-- Main content -->
	...
	if($_POST['jobtype']=='mobile')
	{
			...
			$mobi=mysql_query($mob);
			$mobil=mysql_fetch_array($mobi);
		
			$mob1="select * from a_customer_vehicle_details where cust_no='".$mobil['id']."'";
			$mobi1=mysql_query($mob1);
			$mobil1=mysql_fetch_array($mobi1); 
	}
	...
	if($_POST['jobtype']=='customer')
	{
			...
			?>
				...
				while($FEss=mysql_fetch_array($Ess))
				{
					...
					$Esjobcard=mysql_query($sjobcard);
					$Fsjobcard=mysql_fetch_array($Esjobcard);
					$i++;
				?>
                <tr>
                <td><?php echo $i;?></td>
			...
			<hr>
			   ...
			   <input type="date" class="form-control" name="jdate" id="jdate" value="<?php echo date("Y-m-d"); ?>"  onKeyPress="return tabE(this,event)" required>
				...
				$mob1="select * from a_customer_vehicle_details where cust_no='".$mobil['id']."'";
				$mobi1=mysql_query($mob1);
				while($mobil1=mysql_fetch_array($mobi1))
				{
				?>	
				...
				$rfq=mysql_query($rfs);
				$rff=mysql_fetch_array($rfq);
				$ln=mysql_num_rows($rfq);
                if($ln<'1')
				{
				?>
				 ...
				 <h2>Customer Reference Scheme </h2>
					 <div class="form-group col-sm-4">
					  ...
					  <?php
			            ...
			            $custfetch1=mysql_query($custse1);
			            $cust1=mysql_fetch_array($custfetch1);  
				...
				$Esinv=mysql_query($sinv);
				$FEsinv=mysql_fetch_array($Esinv);
				?>
...
<div class="form-group col-sm-3">
			  <label><input type="checkbox" id="Jack" name="Jack" value="1" <?php if($FEsinv['Jack']=='1') { ?> checked="true" <?php } ?>> Jack</label>
				...
				<br>
				 ...
				 <h3>Type Of Vehicle Damages </h3>
					 <div class="form-group col-sm-4">
			          <label for="catname">Vehicle Part Name</label>
			          ...
			          <label for="catname">Type Of Damage</label>
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage']; ?>"><?php echo $_SESSION['TypeOfDamage']; ?></option>
					   <?php
					   }
					   ?>
                      ...
                      <input type="txt" class="form-control" name="Note" id="Note" value="<?php echo $_SESSION['Note']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
						...
						<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName1" id="VehiclePartName1" value="Car Bumper Front"  readonly onKeyPress="return tabE(this,event)">
					  </div>
					 	  <div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage1']; ?>"><?php echo $_SESSION['TypeOfDamage1']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note1" id="Note1" value="<?php echo $_SESSION['Note1']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName2" id="VehiclePartName2" value="Car Bumper Back"  readonly onKeyPress="return tabE(this,event)">
					  </div>
						<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage2']; ?>"><?php echo $_SESSION['TypeOfDamage2']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note2" id="Note2" value="<?php echo $_SESSION['Note2']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName3" id="VehiclePartName3" value="Dickey"  readonly onKeyPress="return tabE(this,event)">
					  </div>
						<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage3']; ?>"><?php echo $_SESSION['TypeOfDamage3']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note3" id="Note3" value="<?php echo $_SESSION['Note3']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName4" id="VehiclePartName4" value="Door Left Front"  readonly onKeyPress="return tabE(this,event)">
					  </div>
							<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage4']; ?>"><?php echo $_SESSION['TypeOfDamage4']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note4" id="Note4" value="<?php echo $_SESSION['Note4']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName5" id="VehiclePartName5" value="Door Right Front"  readonly onKeyPress="return tabE(this,event)">
					  </div>
						<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage5']; ?>"><?php echo $_SESSION['TypeOfDamage5']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note5" id="Note5" value="<?php echo $_SESSION['Note5']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName6" id="VehiclePartName6" value="Door Left Back"  readonly onKeyPress="return tabE(this,event)">
					  </div>
						<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage6']; ?>"><?php echo $_SESSION['TypeOfDamage6']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note6" id="Note6" value="<?php echo $_SESSION['Note6']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName7" id="VehiclePartName7" value="Door Right Back"  readonly onKeyPress="return tabE(this,event)">
					  </div>
						<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage7']; ?>"><?php echo $_SESSION['TypeOfDamage7']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note7" id="Note7" value="<?php echo $_SESSION['Note7']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName8" id="VehiclePartName8" value="Glass Front"  readonly onKeyPress="return tabE(this,event)">
					  </div>
					 	<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage8']; ?>"><?php echo $_SESSION['TypeOfDamage8']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note8" id="Note8" value="<?php echo $_SESSION['Note8']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName9" id="VehiclePartName9" value="Glass Back"  readonly onKeyPress="return tabE(this,event)">
					  </div>
						<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage9']; ?>"><?php echo $_SESSION['TypeOfDamage9']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note9" id="Note9" value="<?php echo $_SESSION['Note9']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName10" id="VehiclePartName10" value="Mirror Left"  readonly onKeyPress="return tabE(this,event)">
					  </div>
					 	<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage10']; ?>"><?php echo $_SESSION['TypeOfDamage10']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
                      ...
                      <input type="txt" class="form-control" name="Note10" id="Note10" value="<?php echo $_SESSION['Note10']; ?>"  placeholder="Note" onKeyPress="return tabE(this,event)">
					  	...
					  	<div class="form-group col-sm-4">
                      <input type="text" class="form-control" name="VehiclePartName11" id="VehiclePartName11" value="Mirror Right"  readonly onKeyPress="return tabE(this,event)">
					  </div>
					 	<div class="form-group col-sm-2">
					   ...
					   {
					   ?>
					   <option value="<?php echo $_SESSION['TypeOfDamage11']; ?>"><?php echo $_SESSION['TypeOfDamage11']; ?></option>
					   <?php
					   }
					   ?>
					   <option value="Dent">Dent</option>
			 ...
			 <div class="form-group col-sm-6">
			   ...
			   <label for="catname"></label>
				...
				$Es=mysql_query($s);
				while($FEs=mysql_fetch_array($Es))
				{
					$i++;
...
<br/>						
			 ...
			 <div class="hidden">
			   ...
			   <label for="catname"></label>
				...
				$pse1=mysql_query($pw1);
				$samt1=mysql_fetch_array($pse1);
				...
				$rfq1=mysql_query($rfs1);
				$rff1=mysql_fetch_array($rfq1);
				$ln1=mysql_num_rows($rfq1);
                if($ln1<'1')
				{
				?>
				<div class="form-group col-sm-4">
				...
				$jcrs=mysql_query($jcr);
				$jcrsf=mysql_fetch_array($jcrs);
				}
				else
				{
				...
				$jcrs1=mysql_query($jcr1);
				$jcrsf1=mysql_fetch_array($jcrs1);
				}
				else
				{
			  ...
			  ?>
                ...
                <input type="txt" class="form-control" name="DiscountAmount" id="DiscountAmount"  value="<?php echo $temp['DiscountAmount'];?>"   onKeyPress="return tabE(this,event)" OnKeyUp="sumgst();" style="text-transform:uppercase">
				</div>
     ...
     Customer Package History
               ...
               <table border="1" width="650" align="left" >
				...
				$FEss=mysql_fetch_array($Ess);
					...
					$esc=mysql_query($dec);
					while($sce=mysql_fetch_array($esc))
					{
					
					$dec1="select * from s_job_card_pdetails where job_card_no='".$sce['id']."'";
					$esc1=mysql_query($dec1);
					while($sce1=mysql_fetch_array($esc1))
					{
