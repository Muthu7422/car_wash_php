	 ...
	 <div class="box-header with-border">
             <?php if($_REQUEST['s']!="") {?> 
			  <div class="alert alert-success">
                <strong>Referral Scheme saved!</strong> <i class="glyphicon glyphicon-ok" style="font-size:30px;color:white"></i>
              </div> <?php } ?>
             <?php if($_REQUEST['u']!="") {?> 
			  <div class="alert alert-success">
			  ...
			  <div class="alert alert-warning">
                 Referral Scheme  <b>already</b> Exist! <i class="fa fa-warning" style="font-size:30px;color:white"></i>
              </div> <?php } ?></div>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <tbody>
				<?php
				$ss="select * from reference_scheme where franchisee_id='".$_SESSION['BranchId']."' order by id desc";
