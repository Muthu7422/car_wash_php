	 ...
	 <div class="box-header with-border">
             <?php if($_REQUEST['s']!="") {?> 
			  <div class="alert alert-success">
                <strong>Spare Types Saved Successfully!</strong> <i class="glyphicon glyphicon-ok" style="font-size:30px;color:white"></i>
              </div> <?php } ?>
             <?php if($_REQUEST['d']!="") {?> 
			  <div class="alert alert-danger">
              <b> Spare Types Deleted Successfully!<i class="fa fa-remove" style="font-size:30px;color:white"></i></b>
              </div> <?php } ?>
			  <?php if($_REQUEST['a']!="") {?> 
			  <div class="alert alert-warning">
                  Spares / Item Category  <b>already</b> exiting! <i class="fa fa-warning" style="font-size:30px;color:white"></i>
              </div> <?php } ?></div>
...
function Delete_Click() {
  ...
  return false; 
    ...
    <form role="form" method="post" action="m_spare_type_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="stype" id="stype" placeholder="Spare Type" onKeyPress="return tabE(this,event)" required>
                </div>
				<div class="form-group col-sm-4">
