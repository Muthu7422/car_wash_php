...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="user_role_editQ.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
			  ...
			  <div class="form-group col-sm-4 " hidden>
				...
				<div class="form-group col-sm-4">
                 ...
                 <input type="text" class="form-control" name="role_name" id="role_name" placeholder="Role Name" value="<?php echo $FEss['role_name'];?>"onKeyPress="return tabE(this,event)" required>
                </div>
				<div class="form-group col-sm-4">
