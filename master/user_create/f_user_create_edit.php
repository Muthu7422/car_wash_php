...
$id=$_REQUEST['id'];
$ct="update f_user_create set user_role='".$_POST['role_name']."',user_name='".$user_name."',branch_name='".$_POST['branch_name']."',company_name='".$_POST['company_name']."',financial_year='".$_POST['financial_year']."',password='".$password."' WHERE id='$id'";
