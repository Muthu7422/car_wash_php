   ...
   <div class="box-header with-border">
             <?php if($_REQUEST['s']!="") {?> 
			  <div class="alert alert-success">
                <strong>User Create Saved Successfully!</strong> <i class="glyphicon glyphicon-ok" style="font-size:30px;color:white"></i>
              </div> <?php } ?>
             <?php if($_REQUEST['d']!="") {?> 
			  <div class="alert alert-success">
              <b> User Create Update Successfully!<i class="glyphicon glyphicon-ok" style="font-size:30px;color:white"></i></b>
              </div> <?php } ?>
			  <?php if($_REQUEST['a']!="") {?> 
			  <div class="alert alert-warning">
                 User <b>already</b> exiting! <i class="fa fa-warning" style="font-size:30px;color:white"></i>
              </div> <?php } ?></div>
    ...
    <section class="content container-fluid">
			...
			?>
            <form class="form-horizontal" method="post" action="f_user_create_view.php">
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-4">
                 <select  class="form-control" name="financial_year" id="financial_year" value=<?php echo $Fct1['financial_year']; ?> readonly required>
			  ...
			  <?php } ?>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select type="text" class="form-control" name="company_name"  id="company_name"  readonly>
												<option></option>
				...
				//  $sql="SELECT m_franchisee.franchisee_name FROM `m_franchisee` left join company ON m_franchisee.franchisee_id=company.id AND "
				  ...
				  ?>
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="password" id="password" value="<?php echo $Fct1['password']; ?>"  placeholder="Password" required readonly>
                      </div>
                    </div>  
				...
				echo  $sqlf1="select * from m_franchisee ";
			  	...
			  	<div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" class="form-control" name="role_name" id="role_name" value="<?php echo $Fct1['user_role']; ?>"  placeholder="User Name" readonly="true">
                      </div>
                    </div> 
	...
	<div class="form-group" hidden>
                      ...
                      <div class="col-sm-4">
                        <select type="text" class="form-control" name="role_name"  id="role_name" readonly >
				...
				//  $sqlf="select * from m_franchisee";
				//  $sql="SELECT m_franchisee.franchisee_name FROM `m_franchisee` left join company ON m_franchisee.franchisee_id=company.id AND "
				  $sqlf="select * from user_role";
				  $resultf=mysqli_query($conn,$sqlf);
				  while ($rowf = mysqli_fetch_array($resultf))
				  {
				  if($Fct1['user_role']==$rowf['role_name'])
				  {
				  ?>
				  <option value="<?php echo $rowf['role_name']; ?>" selected><?php echo $rowf['role_name']; ?></option>
				  <?php
				  }
				  else
				  {
				  ?>
				  <option value="<?php echo $rowf['role_name']; ?>"><?php echo $rowf['role_name']; ?></option>
				  <?php
				  }
                ...
                <tr>
                  ...
                  <td><?php echo $Fct['financial_year']; ?></td>
					  ...
					  <td><?php echo $Fct['user_name']; ?></td>
					    <td hidden><?php echo $Fct['password']; ?></td>
                  <td>
                      <a href="f_user_create_view.php?id=<?php echo $Fct['id']; ?>" onClick="return confirm('Are You Sure Want to Edit?');" class="btn-box-tool"><i class="fa fa-edit custom-icon1"></i></a>
                      <a href="f_user_create_delete.php?id=<?php echo $Fct['id']; ?>" onClick="return confirm('Are You Sure Want to Delete?');" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a>
