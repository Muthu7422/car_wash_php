  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
   ...
   <div class="box-header with-border">
    ...
    <section class="content container-fluid">
            ...
            <h4><div align="right" style=" border::groove; color:#00BFFF"> <a href="f_user_create.php"><button>Add New User</button></a> </div></h4>
            <!-- /.box-header -->
            <!-- form start -->
			...
			?>
            <form class="form-horizontal" method="post" action="f_user_create_edit.php?id=<?php echo $Fct1['id']; ?>">
              <div class="box-body">
	...
	<div class="form-group" >
                      ...
                      <div class="col-sm-4">
                        <select type="text" class="form-control" name="role_name"  id="role_name" >
                ...
                <tr>
                  ...
                  <td>
                      ...
                      <a href="f_user_create_delete.php?id=<?php echo $Fct['id']; ?>" onClick="return confirm('Are You Sure Want to Delete?');" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a>
				          ...
				          <td>
                      <a href="f_user_create_details_view.php?id=<?php echo $Fct['id']; ?>"  class="btn-box-tool"><i class="fa fa-eye custom-icon1"></i></a>
