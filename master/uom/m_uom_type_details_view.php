...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="m_uom_view.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
              <div class="box-body">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="UnitType" id="UnitType" placeholder="Vehicle Type" value="<?php echo $FEss['u_name']; ?>" readonly required>
				...
				<div class="form-group col-sm-4">
                  ...
                  <textarea class="form-control" name="UnitDescription" id="UnitDescription" placeholder="Vehicle Description" readonly><?php echo $FEss['u_description']; ?></textarea>
                </div>
				<div class="form-group col-sm-4">
