			   ...
			   <div class="form-group col-sm-4">
                ...
                <div class="form-group col-sm-4">
				 ...
				 <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="labour_amt" id="labour_amt" value="<?php echo $spc['labour_amt']; ?>" placeholder="Labour Charge" onKeyPress="return tabE(this,event)" >
                </div>
				 <div class="form-group col-sm-4">
