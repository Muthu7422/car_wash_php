...
function Delete_Click() {
    ...
    <form role="form" method="post" action="membership_edit_act.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
              <div class="box-body">
				...
				<div class="form-group col-sm-4">
                  ...
                  <input class="form-control" name="MemberShipName" id="MemberShipName" value="<?php echo $FEg['MemberShip']; ?>" required>
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">MemberShip Description</label>
                  <input class="form-control" name="MemberShipDescription" id="MemberShipDescription" value="<?php echo $FEg['Description']; ?>" required>
                </div>
