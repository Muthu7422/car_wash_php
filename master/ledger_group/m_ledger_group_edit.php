...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="m_spare_type_editQ.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
              <div class="box-body">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="stype" id="stype" placeholder="Service Type" value="<?php echo $FEss['stype']; ?>" required>
