...
$rs="select * from referrer_scheme";
	 ...
	 <div class="box-header with-border">
             <?php if($_REQUEST['s']!="") {?> 
			  <div class="alert alert-success">
                <strong>Referrer Scheme saved!</strong> <i class="glyphicon glyphicon-ok" style="font-size:30px;color:white"></i>
              </div> <?php } ?>
             <?php if($_REQUEST['u']!="") {?> 
			  <div class="alert alert-success">
			  ...
			  <div class="alert alert-warning">
                 Referrer Scheme  <b>already</b> Exist! <i class="fa fa-warning" style="font-size:30px;color:white"></i>
              </div> <?php } ?></div>
...
function Delete_Click() {
  ...
  return false; 
    ...
    <form role="form" method="post" action="referrer_scheme_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
		...
		<?php
			...
			// $refs="select * from referrer_scheme";
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <tbody>
				<?php
				$ss="select * from referrer_scheme where franchisee_id='".$_SESSION['BranchId']."' order by id desc";
