...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="referrer_scheme_view.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
			...
			?>
			  ...
			  <div class="form-group col-sm-4 hidden">
				...
				<div class="form-group col-sm-4">
                 ...
                 <input type="number" class="form-control" name="ReferenceAmount" id="ReferenceAmount" placeholder="Reference Amount" value="<?php echo $FEss['ReferenceAmount'];?>"onKeyPress="return tabE(this,event)" required readonly>
                </div>
				<div class="form-group col-sm-4">
