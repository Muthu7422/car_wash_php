...
$pagename="m_spare_brand_view.php";
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content container-fluid">
      <?php 
					  ...
					  {
					  ?>
       <h4><div align="right"><a href="m_spare_brand.php"><b> CREATE NEW SPARE BRAND</b></a></div></h4>  
					  <?php } ?>
	    <!-- left column -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header">
              <h3 class="box-title">Available Spare Brands</h3>
            </div>
            <!-- /.box-header -->
		  <?php 
		...
		<?php
                ...
                <td><?php echo $i; ?></td>
				 ...
				 <td> <a href="m_spare_brand_details_view.php?id=<?php  echo $FEss['sid']; ?>" class="btn-box-tool"><i class="fa fa-eye custom-icon1"></i></a></td>
                  <td>
				  		<?php 
		  		   ...
		  		   <?php 
					  ...
					  {
					  ?>
				  <a href="m_spare_brand_delete.php?id=<?php  echo $FEss['sid']; ?>" class="btn-box-tool"><i class="fa fa-close custom-icon1"></i></a> 
					  <?php }	 ?>
