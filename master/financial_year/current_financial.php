...
function Delete_Click() {
  ...
  return false; 
    ...
    <form role="form" method="post" action="current_financial_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
			  ...
			  ?>
                <div class="form-group col-sm-4">
                  ...
                  <select type="text" class="form-control" name="financial_year" id="financial_year" placeholder="Financial Year" onKeyPress="return tabE(this,event)" required>
				 ...
				 <?php
				  ...
				  <option value="<?php echo $duplicate1['financial_year']; ?>"><?php echo $duplicate1['financial_year']; ?></option>
				  <?php } ?>
				  </select>
                  </div>
				...
				<div class="form-group col-sm-4" >
                  ...
                  <input class="form-control" name="franchisee_id" id="franchisee_id" value=<?php echo $duplicate['id']?> placeholder="Branch Name" onKeyPress="return tabE(this,event)"></input>
                </div>
            </div>
              <!-- /.box-body -->
          </div>
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body" >
                ...
                <tbody>
				<?php
				$ss="select * from financial_year where status='Active' order by id";
