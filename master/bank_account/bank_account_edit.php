...
function Delete_Click() {
  ...
  return false; 
    ...
    <form role="form" method="post" action="bank_account_editQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
			...
			?>
              <div class="box-body">
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="AccountNumber" id="AccountNumber" value="<?php echo $Esw['AccountNumber']; ?>" onKeyPress="return tabE(this,event)" required>
				 ...
				 <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="AccountName" id="AccountName" value="<?php echo $Esw['AccountName']; ?>" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">Bank Name</label>
                  <select type="text" class="form-control" name="BankName" id="BankName" value="" onKeyPress="return tabE(this,event)">
			...
			<div class="box-body">
				<div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="IFSCCode" id="IFSCCode" value="<?php echo $Esw['IFSCCode']; ?>" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">MICR Code</label>
                 <input type="text" class="form-control" name="MICRCode" id="MICRCode" value="<?php echo $Esw['MICRCode']; ?>" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">Swift Code </label>
                 <input type="text" class="form-control" name="SwiftCode" id="SwiftCode" value="<?php echo $Esw['SwiftCode']; ?>" onKeyPress="return tabE(this,event)">
                </div>
				  </div>
				<div class="box-body">
				<div class="form-group col-sm-4">
                  <label for="Branch">Branch</label>
                  <input type="text" class="form-control" name="Branch" id="Branch" value="<?php echo $Esw['Branch']; ?>" onKeyPress="return tabE(this,event)">
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">Amount</label>
                 <input type="text" class="form-control" name="Amount" id="Amount" value="<?php echo $Esw['Amount']; ?>" onKeyPress="return tabE(this,event)">
                </div>
				...
				<div class="form-group col-sm-4">
                 ...
                 <select type="text" class="form-control" name="Status" id="Status" onKeyPress="return tabE(this,event)">
                 ...
                 <select type="text" class="form-control" name="default" id="default"  onKeyPress="return tabE(this,event)">
