...
$pagename="bank_account_view.php";
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <section class="content container-fluid">
      <?php 
					  ...
					  {
					  ?>
       <h4><div align="right"><a href="bank_account.php"><b> CREATE NEW BANK ACCOUNT</b></a></div></h4>  
					  <?php } ?>
	    <!-- left column -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header">
              <h3 class="box-title">Available bank Accounts</h3>
            </div>
            <!-- /.box-header -->
		  <?php 
			...
			<?php
               ...
               <td><?php echo $i; ?></td>
				...
				<td>
				<a href="bank_account_details_view.php?Id=<?php  echo $FEss['Id']; ?>" class="btn-box-tool" ><i class="fa fa-eye custom-icon1"></i></a> 
				</td>
                  <td>
				  		<?php 
