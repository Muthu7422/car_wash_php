...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="m_spares_view.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
				  ...
				  <select class="form-control" id="stype" name="stype" required="true" readonly>
				...
				<div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="sname" id="sname" value="<?php echo $FEss['sname']; ?>" readonly>
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">Units  </label>
                  <select class="form-control" id="units" name="units" onKeyPress="return tabE(this,event)" required readonly>
				   <?php 
				...
				<div class="form-group col-sm-4">
                  <label for="Branch">Spare Part No</label>
                   <input type="text" class="form-control" name="spartno" id="spartno" value="<?php echo $FEss['spartno']; ?>" required readonly> 
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">HSN Code</label>
                   <input type="text" class="form-control" name="hsn" id="hsn" value="<?php echo $FEss['hsn_code']; ?>"  placeholder="hsn" onKeyPress="return tabE(this,event)" readonly>
                </div>
				<div class="form-group col-sm-4">
                  <label for="Branch">M.R.P</label>
                  <input type="text" class="form-control" name="smrp" id="smrp" value="<?php echo $FEss['smrp']; ?>" required readonly>
                </div> 
				<div class="form-group col-sm-4">
                  <label for="Branch">Minimum Stock</label>
                  <input type="text" class="form-control" name="min_stock" id="min_stock" value="<?php echo $FEss['min_stock']; ?>" required readonly>
                </div> 
				<div class="form-group col-sm-4">
                  <label for="Branch">Spare Tax %</label>
                  <input type="text" class="form-control" name="TaxRate" id="TaxRate" value="<?php echo $FEss['TaxRate']; ?>" required readonly>
                </div> 
				<div class="form-group col-sm-4">
                  <label for="Branch">Spare Supplier </label>
                <select class="form-control" id="ssupplier" name="ssupplier" readonly>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <tr>
				  ...
				  <?php  
				  //echo $FEss['stype'];
					$st="select * from m_spare_type where franchisee_id='".$_SESSION['BranchId']."' where sid='".$FEss['stype']."'";
