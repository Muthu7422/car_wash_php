...
function Delete_Click() {
  ...
  return false; 
    ...
    <form role="form" method="post" action="membership_unlimited_addQ.php" autocomplete="off">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
			  <?php 
			   $Es="select * from a_customer where id='".$_REQUEST['cid']."'"; 
			  ...
			  ?>
                 <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="financial_year" id="financial_year" value=<?php echo $duplicate['cust_name']; ?> placeholder="Financial Year" onKeyPress="return tabE(this,event)" required>
                  <input type="hidden" class="form-control" name="CustomerID" id="CustomerID" value=<?php echo $duplicate['id']; ?> placeholder="Financial Year" onKeyPress="return tabE(this,event)" required>
                  </div>
				<div class="form-group col-sm-4">
