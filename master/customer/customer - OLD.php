...
include("../../redirect.php");
 ...
 $abc11="select * from master_vehicle";
 $abcd11=mysql_query($abc11);
 $Brand1="[";
 while($ac11=mysql_fetch_array($abcd11))
 {
	$st1=$ac11['VehicleModel'];
	$Brand1.="'$st1',";
 }
 $Brand1.="]";
    ...
    <section class="content-header">
	  ...
	  <div class="box-header with-border">
             ...
             <?php if($_REQUEST['d']!="") {?> 
			  ...
			  {
			  ?>
                 Invalid Vehicle <b>Details</b> Please Check! <i class="fa fa-warning" style="font-size:30px;color:white"></i>
			  <?php } ?>
			  <?php 
			  if($_REQUEST['a']==3)
			  {
			  ?>
                 Mobile Number <b>already</b> exist! <i class="fa fa-warning" style="font-size:30px;color:white"></i>
			  <?php } ?>
...
function fnCustomerDetails($i){ 
    var inputs = document.getElementById('VehicleBrand'+$i+'').value;
  $.ajax({
      type:'post',
        ...
        //document.getElementById('VehicleModel'+$i+'').value=msg[0];	
		document.getElementById('VehicleBrandId'+$i+'').value=msg[0];
        }
      });
    }
	

function fnCustomermodelDetails($i){ 
  var inputs = document.getElementById('VehicleModel'+$i+'').value;
  $.ajax({
      type:'post',
        url:'ajax_customer_model.php',// put your real file name 
        data:{inputs},
		dataType: 'json',
        success:function(msg){
        // your message will come here.  
		document.getElementById('VehicleSegment'+$i+'').value=msg[0];
		document.getElementById('VehicleType'+$i+'').value=msg[1];
		document.getElementById('VehicleModelId'+$i+'').value=msg[2];
        }
      });
     }
...
{
	if(document.getElementById("VehicleSegment1").value!='')
		return true;	
	else
		alert("Please Enter VehicleSegment !");	
		return false;
...
function isMobileNumber()
{
	if(document.getElementById('mobile1').value != ""){
       ...
       var y = document.getElementById('mobile1').value;
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="customer_act.php" autocomplete="off" onsubmit="return confirm('Are You Sure Want to Save?');">
              <div class="box-body">
                  <div class="hidden">
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="customer_name"  id="customer_name" value="<?php  ?>" placeholder="Customer Name" onKeyPress="return tabE(this,event)" style="text-transform:uppercase" required>
                      </div>
                    </div>
                ...
                <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="mobile1"   id="mobile1" pattern="^\d{10}$" onKeyPress="return isNumberKey(event,this);" placeholder="Primary Phone Mobile" onKeyPress="return tabE(this,event)" required>
                      </div>
                    </div>
					<div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">Secondary Phone Mobile</label>
                      <div class="col-sm-8">
                        <input type="number" class="form-control" name="mobile2"  id="mobile2"  placeholder="Secondary Phone Mobile" onKeyDown="if(this.value.length==10) return false;" onKeyPress="return tabE(this,event)" >
                      </div>
                    </div>
					<div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">Email Id</label>
                      <div class="col-sm-8">
                        <input type="email" class="form-control" name="email" autofocus="autofocus" id="email" placeholder="Email Id" onKeyPress="return tabE(this,event)" >
                      </div>
                    </div>  
					...
					<div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">AquraMiles Customer? </label>
                      <div class="col-sm-8">
					...
					<?php 
						$cus="select * from a_customer where status='Active'";
						$Ecus=mysql_query($cus);
						$FEcus=mysql_fetch_array($Ecus)
						
						?>
					<div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">Aqura Customer Number </label>
                       <?php
				  $in="select * from a_customer";
				  ...
				  ?>
					  <div class="col-sm-8">
                        <input type="text" class="form-control" name="customer_no"  id="customer_no" value="<?php echo ACN19000000.$ns1 ?>" onKeyPress="return tabE(this,event)" style="text-transform:uppercase" >
                      </div>
                    </div>
          ...
          <div class="box box-danger">
            ...
            <div class="box-body no-padding" style="overflow:auto">
              <table class="table-bordered padding-4 disp" style="width:110%;height:20px" >
                ...
                <tr>
                <td><?php echo $i; ?> </td>
				<td><input name="<?php echo "VehicleBrand".$i ?>" id="<?php echo "VehicleBrand".$i ?>" type="text" size="8"  onKeyPress="return tabE(this,event)" class="form-control" onblur="fnCustomerDetails(<?php echo $i; ?>)" <?php if($i==1){ ?> required <?php } ?> style="text-transform:uppercase"></td>
                <td><input name="<?php echo "VehicleModel".$i ?>" id="<?php echo "VehicleModel".$i ?>" type="text" size="8"  onKeyPress="return tabE(this,event)" class="form-control" onblur="fnCustomermodelDetails(<?php echo $i; ?>)" <?php if($i==1){ ?> required <?php } ?> style="text-transform:uppercase"></td>
          	    <td><input name="<?php echo "VehicleSegment".$i ?>"  id="<?php echo "VehicleSegment".$i ?>" type="text" size="2" onKeyPress="return tabE(this,event)" class="form-control" style="text-transform:uppercase" readonly required></td>
				<td><input name="<?php echo "VehicleType".$i ?>"  id="<?php echo "VehicleType".$i ?>" type="text" size="4" onKeyPress="return tabE(this,event)" class="form-control" style="text-transform:uppercase" readonly required></td>
                ...
                <td><input name="<?php echo "VehicleNo".$i ?>" id="<?php echo "VehicleNo".$i ?>"   type="text" size="4" pattern="^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9]+$"  onKeyPress="return tabE(this,event)" class="form-control" <?php if($i==1){ ?> required <?php } ?> style="text-transform:uppercase"></td>
				...
				<td style="display:none"><input name="<?php echo "VehicleBrandId".$i ?>"  id="<?php echo "VehicleBrandId".$i ?>" size="4" type="text" onKeyPress="return tabE(this,event)" size="2" class="form-control"></td>
          ...
          <!-- /.box -->
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-default " onclick="javascript:window.location='<?php echo $_SESSION['path'];?>admin.php';">Cancel</button>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped" width="100%">
				...
				<th>Cust No</th>
				  ...
				  <th style="text-align:right">Miles Earning </th>
                ...
                <tr style="background-color:<?php echo $bg; ?>">
				  ...
				  <td>
                      <a href="customer_edit.php?id=<?php echo $Fct['id']; ?>"  class="btn-box-tool" title="Edit Customer"><i class="fa fa-edit custom-icon1" style="font-size:23px"></i></a> 
                      
                  </td>
				  <td><?php echo $Fct['AMCEarned']-$Fct['AMCUsed'];  ?></td>
...
customers1 = <?php echo $Brand1; ?>;

/*initiate the autocomplete function on the "myInput" element, and pass along the countries array as possible autocomplete values:*/
//autocomplete(document.getElementById("vehicle"), countries);

autocomplete(document.getElementById("VehicleBrand1"), customers);
autocomplete(document.getElementById("VehicleBrand2"), customers);
autocomplete(document.getElementById("VehicleBrand3"), customers);
autocomplete(document.getElementById("VehicleBrand4"), customers);
autocomplete(document.getElementById("VehicleBrand5"), customers);

autocomplete(document.getElementById("VehicleModel1"), customers1);
autocomplete(document.getElementById("VehicleModel2"), customers1);
autocomplete(document.getElementById("VehicleModel3"), customers1);
autocomplete(document.getElementById("VehicleModel4"), customers1);
autocomplete(document.getElementById("VehicleModel5"), customers1);
