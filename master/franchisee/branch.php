...
include("../../redirect.php");
   ...
   $sa1="select * from m_vendor where id='".$_REQUEST['id']."'";
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post" action="branch_act.php" autocomplete="off" enctype="multipart/form-data">
              <div class="box-body">
	            ...
	            <input type="text" class="form-control" name="branch_id"  id="branch_id" value="<?php echo $pn;  ?>" placeholder="Franchisee ID" onKeyPress="return tabE(this,event)" readonly style="text-transform:uppercase" required>
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="vendor"  id="vendor" value="<?php echo $n1['franchisee_name'];  ?>" placeholder="Company Name" onKeyPress="return tabE(this,event)" required readonly >
                        <input type="hidden" class="form-control" name="vendor_id"  id="vendor_id" value="<?php echo $n1['vendor_id'];  ?>" placeholder="Company Name" onKeyPress="return tabE(this,event)" required readonly >
                      </div>
                    </div>
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="franchisee_name" autofocus="autofocus" id="franchisee_name" value="<?php  ?>" placeholder="Branch Name" onKeyPress="return tabE(this,event)" style="text-transform:uppercase" >
                      </div>
                    </div>
        ...
        <div class="col-md-12 hidden">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
				<?php
				$ct="select * from m_franchisee order by franchisee_name";
