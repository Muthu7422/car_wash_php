        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Branch  Edit Details</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
			<?php
			...
			$ct1="select * from m_franchisee where id='".$_REQUEST['id']."'";
				$Ect1=mysqli_query($conn,$ct1);
				$Fct1=mysqli_fetch_array($Ect1);
				$n=mysqli_num_rows($Ect1);
			?>
            <form class="form-horizontal" method="post" action="branch_edit_act.php?id=<?php echo $Fct1['id']; ?>"  enctype="multipart/form-data">
              ...
              <div class="box-body">
	            ...
	            <input type="text" class="form-control" name="vendor_id"  id="vendor_id" value="<?php echo $Fct1['vendor_id'];  ?>" placeholder="Franchisee ID" onKeyPress="return tabE(this,event)" readonly style="text-transform:uppercase" required>
				...
				<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="franchisee_name" autofocus="autofocus" id="franchisee_name" value="<?php echo $Fct1['franchisee_name']  ?>" placeholder="Franchisee Name" onKeyPress="return tabE(this,event)" style="text-transform:uppercase" required>
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select type="text" class="form-control" name="vendor_id" autofocus="autofocus" id="vendor_id" value="<?php  ?>" placeholder="Company Name" onKeyPress="return tabE(this,event)" style="text-transform:uppercase" required>
						<?php 
						$ct="select * from m_vendor where status='Active'";
				        $Ect=mysqli_query($conn,$ct);
				        $i=0;
				        while($Fct=mysqli_fetch_array($Ect))
				        {
						 if($Fct1['vendor_id']==$Fct['vendor_id'])
				  {
				  ?>
				  <option value="<?php echo $Fct['vendor_id']; ?>" selected><?php echo $Fct['franchisee_name']; ?></option>
				  <?php
				  }
				  else
				  {
				  ?>
				  <option value="<?php echo $Fct['vendor_id']; ?>"><?php echo $Fct['franchisee_name']; ?></option>
				  <?php
				  }}?>
				   		</select>
                      </div>
                ...
                <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="address" autofocus="autofocus" id="address" value="<?php echo $Fct1['address']  ?>" placeholder="Address" onKeyPress="return tabE(this,event)" style="text-transform:uppercase">
                      </div>
                    </div>
                      ...
                      <div class="col-sm-8">
                        ...
                        <input type="text" class="form-control" name="mobile" autofocus="autofocus" id="mobile" value="<?php echo $Fct1['mobile']  ?>" placeholder="Mobile No" onKeyPress="return tabE(this,event)" style="text-transform:uppercase">
                      </div>
                    </div>
											<div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="cen_manager" autofocus="autofocus" id="cen_manager" value="<?php echo $Fct1['cen_manager']  ?>" placeholder="Center Manager" onKeyPress="return tabE(this,event)" >
                      </div>
                    </div> 	
						<div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">Contact Number</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="con_num" autofocus="autofocus" id="con_num" value="<?php echo $Fct1['con_number']  ?>" placeholder="Contact Number" onKeyPress="return tabE(this,event)" >
                      </div>
                    </div> 	
 <div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">GSTIN</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="gstin" autofocus="autofocus" id="gstin" value="<?php echo $Fct1['gst_no']  ?>" placeholder="GSTIN" onKeyPress="return tabE(this,event)" >
                      </div>
                    </div> 						
   					<div class="form-group">
                      <label for="catname" class="col-sm-3 control-label">Remarks</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="Remarks" autofocus="autofocus" id="Remarks" value="<?php echo $Fct1['Remarks']; ?>" placeholder="Remarks" onKeyPress="return tabE(this,event)" >
                      </div>
                    </div>
							<div class="form-group">
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select type="text" class="form-control" name="status" autofocus="autofocus" id="status" placeholder="GST NO" onKeyPress="return tabE(this,event)" >
