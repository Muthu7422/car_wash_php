...
<div class="wrapper">
 ...
 <!-- Side Bar End -->
  ...
  <div class="content-wrapper" style="background-color:#ECF0F5">
    ...
    <form role="form" method="post" action="m_supplier_editQ.php">
      <div class="row">
        <!-- left column -->
        <div class="col-md-12">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
                  ...
                  <input type="text" class="form-control" name="sname" id="sname" placeholder="Supplier Name" value="<?php echo $FEss['sname']; ?>" required>
				  <input type="hidden" class="form-control" name="sid" id="sid" value="<?php echo $FEss['sid']; ?>">
                </div>
				
				 <div class="form-group col-sm-4">
                  <label for="Branch">Supplier Mobile</label>
                  <input type="text" class="form-control" name="smobile1" id="smobile1" placeholder="Supplier Mobile" value="<?php echo $FEss['smobile1']; ?>" >
                </div>
				
				
				<div class="form-group col-sm-4">
                  <label for="Branch">Supplier Secondary Mobile</label>
                  <input type="text" class="form-control" name="smobile2" id="smobile2" value="<?php echo $FEss['smobile2']; ?>" placeholder="Secondary Mobile">
                </div>
				
				<div class="form-group col-sm-4">
                  <label for="Branch">Supplier Address</label>
                  <textarea class="form-control" name="saddress" id="saddress" placeholder="Supplier Addres" ><?php echo $FEss['saddress']; ?></textarea>
                </div>
				
				<div class="form-group col-sm-4">
                  <label for="Branch">Supplier City</label>
                  <input type="text" class="form-control" name="scity" id="scity" placeholder="Supplier City" value="<?php echo $FEss['scity']; ?>" >
                </div>
				...
				<div class="form-group col-sm-4">
                 ...
                 <input type="email" class="form-control" name="semail" id="semail" placeholder="Email ID" value="<?php echo $FEss['semail']; ?>" >
                </div>
				...
				<div class="form-group col-sm-4 hidden">
                 ...
                 <input type="text" class="form-control" name="opening_balance" id="opening_balance" placeholder="Opening Balance" value="<?php echo $ttlos; ?>"onKeyPress="return tabE(this,event)">
                </div>
              ...
              <div class="box-body">
                ...
                <div class="form-group col-sm-4">
                  <label for="Branch">Supplier Name</label>
                  <input type="text" class="form-control" name="shipping_name" id="shipping_name" placeholder="Supplier Name" value="<?php echo $FEss['shipping_name']; ?>" onfocus="CopyBilling();" onKeyPress="return tabE(this,event)" required>
				 ...
				 <div class="form-group col-sm-4">
                  <label for="Branch">Supplier Mobile</label>
                  <input type="text" class="form-control" name="shipping_mobile1" id="shipping_mobile1" value="<?php echo $FEss['shipping_mobile1']; ?>" placeholder="Supplier Mobile" onKeyPress="return tabE(this,event)">
                </div>
				
				
				<div class="form-group col-sm-4">
                  <label for="Branch">Supplier Secondary Mobile</label>
                  <input type="text" class="form-control" name="shipping_mobile2" id="shipping_mobile2" value="<?php echo $FEss['shipping_mobile2']; ?>" placeholder="Secondary Mobile" onKeyPress="return tabE(this,event)">
                </div>
			
				<div class="form-group col-sm-4">
                  <label for="Branch">Supplier Address</label>
                  <textarea class="form-control" name="shipping_address" id="shipping_address"  placeholder="Supplier Addres" onKeyPress="return tabE(this,event)"><?php echo $FEss['shipping_address']; ?></textarea>
                </div>
				
					<div class="form-group col-sm-4">
                  <label for="Branch">Supplier City</label>
                  <input type="text" class="form-control" name="shipping_city" id="shipping_city" value="<?php echo $FEss['shipping_city']; ?>" placeholder="Supplier City" onKeyPress="return tabE(this,event)">
                </div>
				...
				<div class="form-group col-sm-4">
                  <label for="Branch">Email ID</label>
                 <input type="email" class="form-control" name="shipping_email" id="shipping_email" value="<?php echo $FEss['shipping_email']; ?>" placeholder="Email ID" onKeyPress="return tabE(this,event)">
                </div>
              ...
              <div class="box-body">
				...
				<div class="form-group col-sm-4 hidden">
                 ...
                 <input type="text" class="form-control" name="LedgerId" id="LedgerId" placeholder="Supplier Ledger Id" value="<?php echo $FEss['LedgerId']; ?>" onKeyPress="return tabE(this,event)">
                </div>
